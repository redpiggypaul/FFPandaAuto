...
public class AppTestAccount extends FF_PandaAppTestTemplate {
    ...
    public void change_Email(String theUserPara, String thePSW, String paraGroup, String targetResultType, StringBuilder expectResult) throws Exception {
        ...
        try {
            ...
            theTCRunner.comOperationInIOS((IOSDriver) driver, this.TestStepList_change_Email_List, para4Action, TargetMobileData.getMobileOS());     // 2nd para is the action sequence
            //  }
            Thread.sleep(2000);
