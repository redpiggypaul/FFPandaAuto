...
public class FFPandaElementEntity {
    ...
    public FFPandaElementEntity(StringBuilder pName, StringBuilder eName, StringBuilder locType, StringBuilder locStr, StringBuilder dValue, StringBuilder tContent, StringBuilder tWin, StringBuilder sMODE) throws Exception {
