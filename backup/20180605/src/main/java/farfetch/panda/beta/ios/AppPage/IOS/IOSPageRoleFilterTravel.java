 ...
 */
public class IOSPageRoleFilterTravel extends IOSPageTemplate {
    protected String fileName = "RoleTravel.json";
    ...
    private static String logSpace4thisPage = " --- IPADPageRoleFilterTravel --";
    ...
    public IOSPageRoleFilterTravel(IOSDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public IOSPageRoleFilterTravel(IOSDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public IOSPageRoleFilterTravel(String theFile, IOSDriver theD, Log theLogger) throws Exception {
    ...
    public HashMap<String, By> getByMap(IOSDriver driver) {
        ...
        result.clear();
        By tempElement = null;
        System.out.println(logSpace4thisPage + "xxxxxx ------ Check the driver in IPADPageRoleFilterTravel . getByMap(IOSDriver driver)   : " + driver.toString());
    ...
    public HashMap<String, By> getByMap(IOSDriver driver, HashMap<String, ElementMapping> eleMap) {
        ...
        result.clear();
        By tempElement = null;
        System.out.println(logSpace4thisPage + "xxxxxx ------ Check the driver in IPADPageRoleFilterTravel . getByMap (IOSDriver driver, HashMap<String, ElementMapping> eleMap)  : " + driver.toString());
    ...
    public String itemListOperation(IOSDriver driver, String eleName) throws Exception {
        ...
        System.out.println("    +++ ~~~ The itemListOperation in IPADPageRoleFilterTravel has been called ~~~ +++");
    ...
    public String btnOperationRoute(IOSDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperationRoute in IPADPageRoleFilterTravel has been called ~~~ +++");
    ...
    public void btnOperation(IOSDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperation in IPADPageRoleFilterTravel has been called ~~~ +++");
    ...
    public String getElementContent(IOSDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The getElementContent in IPADPageRoleFilterTravel has been called ~~~ +++");
        boolean movecheckdisable = this.content.getFlag4MoveCheck();
        boolean moveable = this.content.getMoveable();
        boolean localMoveable = false;
        String result = null;
    ...
    public String textOperationWithSaveInput(IOSDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperationWithSaveInputn in IPADPageRoleFilterTravel has been called ~~~ +++");
    ...
    public String dropDownListOperation(IOSDriver driver, String eleName) throws Exception {  //TODO
        ...
        String dropItemValue = null;
        System.out.println("    +++ ~~~ The dropDownListOperation in IPADPageRoleFilterTravel has been called ~~~ +++");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            IOSPageRoleFilterTravel x = new IOSPageRoleFilterTravel("/PageXML/AND/loginPage.xml", driver, null);
