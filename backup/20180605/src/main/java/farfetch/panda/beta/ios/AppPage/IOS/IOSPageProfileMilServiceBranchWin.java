 ...
 */
public class IOSPageProfileMilServiceBranchWin extends IOSPageTemplate {
    protected String fileName = "ProfileMilServiceBranchWin.json";
    ...
    private static String logSpace4thisPage = " --- IPADPageProfileMilServiceBranchWin --";
    ...
    public IOSPageProfileMilServiceBranchWin(IOSDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public IOSPageProfileMilServiceBranchWin(IOSDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public IOSPageProfileMilServiceBranchWin(String theFile, IOSDriver theD, Log theLogger) throws Exception {
    ...
    public String btnOperationRoute(IOSDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperationRoute in IPADPageProfileMilServiceBranchWin has been called ~~~ +++");
    ...
    public HashMap<String, By> getByMap(IOSDriver driver) {
        ...
        result.clear();
        By tempElement = null;
        System.out.println(logSpace4thisPage + "xxxxxx ------ Check the driver in IPADPageProfileMilServiceBranchWin . getByMap (IOSDriver driver)  : " + driver.toString());
    ...
    public HashMap<String, By> getByMap(IOSDriver driver, HashMap<String, ElementMapping> eleMap) {
        ...
        result.clear();
        By tempElement = null;
        System.out.println(logSpace4thisPage + "xxxxxx ------ Check the driver in IPADPageProfileMilServiceBranchWin . getByMap (IOSDriver driver, HashMap<String, ElementMapping> eleMap)  : " + driver.toString());
    ...
    public void btnOperation(IOSDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperation in IPADPageProfileMilServiceBranchWin has been called ~~~ +++");
    ...
    public void textOperation(IOSDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperation in IPADPageProfileMilServiceBranchWin has been called ~~~ +++");
    ...
    public String getElementContent(IOSDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The getElementContent in IPADPageProfileMilServiceBranchWin has been called ~~~ +++");
    ...
    public String textOperationWithSaveInput(IOSDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperationWithSaveInput in IPADPageProfileMilServiceBranchWin has been called ~~~ +++");
        ...
        try {
            ...
            System.out.println(logSpace4thisPage + "In IPADPageProfileMilServiceBranchWin . textOperationWithSaveInput , Other Error appear : " + e.getCause());
            e.printStackTrace();
        } finally {
            return result;
        }
    ...
    public void moveUP(IOSDriver dr) throws Exception {
        System.out.println(" moveUP in IPADPageProfileMilServiceBranchWin ");
        super.moveUPtest(dr);
    }

    public void moveUPall(IOSDriver dr) throws Exception {
        System.out.println(" moveUPall in IPADPageProfileMilServiceBranchWin ");
        super.moveUPall(dr);
    }

    public void moveDOWN(IOSDriver dr) throws Exception {
        System.out.println(" moveDown in IPADPageProfileMilServiceBranchWin ");
    ...
    public boolean pressDateItem(IOSDriver theD, String theDay) throws Exception {  // type4check : ready, loading, error, temp , etc.  , para4check: target element name, all element, title element
        ...
        if (theItem == null) {
            ...
            if (currentDayStr.equals(targetDay)) {
                ...
                //  theItem.getLocation();
                //  theItem.getSize();
                result = super.pressTheRound(theD, (IOSElement) theItem, Integer.parseInt(targetDay), roundSco, rollUP);      // true for up
            }
            System.out.println("Current value in roller is : " + result);
        }
    ...
    public boolean pressDDItem(IOSDriver theD, String theValue) throws Exception {  // type4check : ready, loading, error, temp , etc.  , para4check: target element name, all element, title element
        String targetValue = theValue;
        int roundSco = this.roundScope; // 5 in the windows
        boolean flag = false;
        WebElement theItem = null;
        boolean rollUP = false;
        ...
        for (Iterator it = this.byMap.entrySet().iterator(); it.hasNext(); ) {
            final Map.Entry tempContentEntry = (Map.Entry) it.next();
            if (tempContentEntry.getKey().toString().contains("Roll")) {
                System.out.println("Roll" + " ::" + tempContentEntry.getKey().toString());
                IOSDriverWait xWait = new IOSDriverWait(theD, timeOutInSeconds, this.path4Log);
                theItem = theD.findElement((By) tempContentEntry.getValue());
                break;
            }
        ...
        if (theItem == null) {
            throw new REXException("failed to find the Roll");
        } else {
            String currentDayStr = theItem.getText();
            if (currentDayStr.equals(targetValue)) {
                flag = true;
            } else {
                result = super.pressTheRound(theD, (IOSElement) theItem, theValue, roundSco, true);      // true for up
            }
            System.out.println("Current value in roller is : " + result);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            IOSPageProfileMilServiceBranchWin x = new IOSPageProfileMilServiceBranchWin("/PageXML/AND/bProfileEditPublication.xml", driver, null);
