 ...
 */
public class IOSPageProfileEditSkill extends IOSPageTemplate {
    protected String fileName = "ProfileEditSkills.json";
    ...
    public IOSPageProfileEditSkill(IOSDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public IOSPageProfileEditSkill(IOSDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public IOSPageProfileEditSkill(String theFile, IOSDriver theD, Log theLogger) throws Exception {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            IOSPageProfileEditSkill x = new IOSPageProfileEditSkill("/PageXML/AND/loginPage.xml", driver, null);
