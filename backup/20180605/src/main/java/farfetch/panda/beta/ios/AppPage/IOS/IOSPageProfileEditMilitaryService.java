 ...
 */
public class IOSPageProfileEditMilitaryService extends IOSPageTemplate {
    protected String fileName = "ProfileEditMilitaryService.json";
    ...
    private String dropDownWin = "ProfileMilServiceBranchWin";
    ...
    private static String logSpace4thisPage = " --- IPADPageProfileEditMilitaryService --";
    ...
    public IOSPageProfileEditMilitaryService(IOSDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public IOSPageProfileEditMilitaryService(IOSDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public IOSPageProfileEditMilitaryService(String theFile, IOSDriver theD, Log theLogger) throws Exception {
    ...
    public HashMap<String, By> getByMap(IOSDriver driver) {
        ...
        result.clear();
        By tempElement = null;
        System.out.println(logSpace4thisPage + "xxxxxx ------ Check the driver in IPADPageProfileEditMilitaryService . getByMap(IOSDriver driver)   : " + driver.toString());
    ...
    public HashMap<String, By> getByMap(IOSDriver driver, HashMap<String, ElementMapping> eleMap) {
        ...
        result.clear();
        By tempElement = null;
        System.out.println(logSpace4thisPage + "xxxxxx ------ Check the driver in IPADPageProfileEditMilitaryService . getByMap (IOSDriver driver, HashMap<String, ElementMapping> eleMap)  : " + driver.toString());
    ...
    public String btnOperationRoute(IOSDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperationRoute in IPADPageProfileEditMilitaryService has been called ~~~ +++");
    ...
    public void btnOperation(IOSDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperation in IPADPageProfileEditMilitaryService has been called ~~~ +++");
    ...
    public String getElementContent(IOSDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The getElementContent in IPADPageProfileEditMilitaryService has been called ~~~ +++");
        boolean movecheckdisable = this.content.getFlag4MoveCheck();
        boolean moveable = this.content.getMoveable();
        boolean localMoveable = false;
        String result = null;
    ...
    public String textOperationWithSaveInput(IOSDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperationWithSaveInputn in IPADPageProfileEditMilitaryService has been called ~~~ +++");
    ...
    public String calendarOperationDate(IOSDriver driver, String eleName, String tDate) throws Exception {
        ...
        if (((String) comPageCheckResult).equals("pass")) {
            ...
            if (Integer.parseInt(defaultDay) - 1 >= Integer.parseInt(localTDate)) {
                int yesterdayInt = Integer.parseInt(defaultDay) - 1;  //TODO, consider the 1st day og the month
                if (Integer.parseInt(localTDate) <= yesterdayInt) {
                    Object selectDateResult = chooseMethod.invoke(tempIns, driver, localTDate); // chooseDateItem
                    if (selectDateResult.toString().equalsIgnoreCase("true")) {
                        Method saveMethod = tempClassType.getDeclaredMethod("saveDate", new Class[]{IOSDriver.class, String.class, String.class});
                        Object saveDateResult = saveMethod.invoke(tempIns, driver, localTDate, this.path4Log);
                        if (saveDateResult.toString() != "" && saveDateResult != null) {
                            result = saveDateResult.toString();
                            calendarValue = super.calendarGetTextOperation(driver, eleName, this.byMap, this.eleContentMap, this.path4Log);
                            System.out.println(" ~~~~~~ Here is the date in calendar after save : " + calendarValue.toString());
    ...
    public String dropDownListOperation(IOSDriver driver, String eleName, String extPara) throws Exception {  //TODO
        String defaultText = null;
        String dropItemValue = null;
        String localTValue = extPara;
        String result = null;
        System.out.println("    +++ ~~~ The dropDownListOperation in bANDPageProfileEditEducation has been called ~~~ +++");
        System.out.println(" this time we want to choose the " + extPara + " item ");
        result = super.calendarOperation(driver, eleName, this.byMap, this.eleContentMap, this.path4Log);

        Class tempClassType = Class.forName(String.valueOf(new StringBuffer("REXSH.REXAUTO.APPunderTest.AppPage.IOS.").append("IOSPage").append(dropDownWin)));
        Object tempIns = super.createInstance(tempClassType, driver);
        Method chooseMethod = tempClassType.getDeclaredMethod("pressDDItem", new Class[]{IOSDriver.class, String.class});

        Object selectDateResult = chooseMethod.invoke(tempIns, driver, localTValue); // chooseDDItem

        if (selectDateResult.toString().equalsIgnoreCase("true")) {
            Method getvalueMethod = tempClassType.getDeclaredMethod("getElementContent", new Class[]{IOSDriver.class, String.class});
            Object tempResult = getvalueMethod.invoke(tempIns, driver, "overview_" + eleName);
            dropItemValue = tempResult.toString();
            Method saveMethod = tempClassType.getDeclaredMethod("btnOperationRoute", new Class[]{IOSDriver.class, String.class});
            Object saveDateResult = saveMethod.invoke(tempIns, driver, "OKBtn");
    ...
    public String pressItemString(IOSDriver theD, String theDay, String eleName) throws Exception {  // type4check : ready, loading, error, temp , etc.  , para4check: target element name, all element, title element
        ...
        if (theItem == null) {
            throw new FFPandaException("failed to find the " + eleName + "_picker");
        } else {
...
*/
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            IOSPageProfileEditMilitaryService x = new IOSPageProfileEditMilitaryService("/PageXML/AND/loginPage.xml", driver, null);
