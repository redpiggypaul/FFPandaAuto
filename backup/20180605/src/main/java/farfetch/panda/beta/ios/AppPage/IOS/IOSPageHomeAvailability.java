 ...
 */
public class IOSPageHomeAvailability extends IOSPageTemplate {
    protected String fileName = "HomeAvailability.json";
    ...
    private String dateWin = "AvailableDateWin";
    ...
    private static String logSpace4thisPage = " --- IOSPageHomeAvailability --";
    ...
    public IOSPageHomeAvailability(IOSDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public IOSPageHomeAvailability(IOSDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public IOSPageHomeAvailability(String theFile, IOSDriver theD, Log theLogger) throws Exception {
    ...
    public HashMap<String, By> getByMap(IOSDriver driver) {
        ...
        result.clear();
        By tempElement = null;
        System.out.println(logSpace4thisPage + "xxxxxx ------ Check the driver in IOSPageHomeAvailability . getByMap(IOSDriver driver)   : " + driver.toString());
    ...
    public HashMap<String, By> getByMap(IOSDriver driver, HashMap<String, ElementMapping> eleMap) {
        ...
        result.clear();
        By tempElement = null;
        System.out.println(logSpace4thisPage + "xxxxxx ------ Check the driver in IOSPageHomeAvailability . getByMap (IOSDriver driver, HashMap<String, ElementMapping> eleMap)  : " + driver.toString());
    ...
    public String btnOperationRoute(IOSDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperationRoute in IOSPageHomeAvailability has been called ~~~ +++");
    ...
    public void btnOperation(IOSDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperation in IOSPageHomeAvailability has been called ~~~ +++");
    ...
    public String getElementContent(IOSDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The getElementContent in IOSPageHomeAvailability has been called ~~~ +++");
        boolean movecheckdisable = this.content.getFlag4MoveCheck();
        boolean moveable = this.content.getMoveable();
        boolean localMoveable = false;
        String result = null;
    ...
    public String textOperationWithSaveInput(IOSDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperationWithSaveInputn in IOSPageHomeAvailability has been called ~~~ +++");
    ...
    public void textOperation(IOSDriver driver, String eleName, String para1) throws Exception {
        ...
        boolean localMoveable = false;
        String eleType = null;
        String eleDVauleText = null;
        for (Iterator it = this.eleContentMap.entrySet().iterator(); it.hasNext() && eleType == null; ) {
            final Map.Entry tempContentEntry = (Map.Entry) it.next();
            if (tempContentEntry.getKey().toString().equalsIgnoreCase(eleName)) {
                eleType = ((ElementMapping) tempContentEntry.getValue()).getType();
                eleDVauleText = ((ElementMapping) tempContentEntry.getValue()).getDefaultValue();
            }
        }
            ...
            if (movecheckdisable == false) {
                ...
                if (localMoveable == true) {
                    if (eleType.equalsIgnoreCase("xpath")) {
                        ...
                        super.textOperationSmart(driver, eleName, para1, this.byMap, this.content.eleDefaultValueMap, eleDVauleText);
                    }
                } else {
                    if (eleType.equalsIgnoreCase("xpath")) {
                ...
                if (moveable == false) {
                    if (eleType.equalsIgnoreCase("xpath")) {
                        ...
                        super.textOperationSmart(driver, eleName, para1, this.byMap, this.content.eleDefaultValueMap, eleDVauleText);  // TODO , this fork should not appear
                    }
                } else {
                    if (eleType.equalsIgnoreCase("xpath")) {
                        super.textOperation(driver, eleName, para1, this.byMap, this.content.eleDefaultValueMap);
    ...
    public String calendarOperationTomorrow(IOSDriver driver, String eleName) throws Exception {
        String result = null;
        String calendarValue = null;
        System.out.println("    +++ ~~~ The calendarOperationTomorrow in IOSPageHomeAvailability has been called ~~~ +++");
        result = super.calendarOperation(driver, eleName, this.byMap, this.eleContentMap, this.path4Log);
        ...
        if (((String) comPageCheckResult).equals("pass")) {
            ...
            if (Integer.parseInt(defaultDay) != lastDayInt) {
                ...
                String yesterdayString = String.valueOf(tDayStr);
                Object selectDateResult = chooseMethod.invoke(tempIns, driver, yesterdayString); // chooseDateItem
                if (selectDateResult.toString().equalsIgnoreCase("true")) {
                    Method saveMethod = tempClassType.getDeclaredMethod("saveDate", new Class[]{IOSDriver.class, String.class, String.class});
                    Object saveDateResult = saveMethod.invoke(tempIns, driver, yesterdayString, this.path4Log);
    ...
    public String dropDownListOperation(IOSDriver driver, String eleName) throws Exception {  //TODO
        ...
        System.out.println("    +++ ~~~ The dropDownListOperation in IOSPageHomeAvailability has been called ~~~ +++");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            IOSPageHomeAvailability x = new IOSPageHomeAvailability("/PageXML/AND/loginPage.xml", driver, null);
