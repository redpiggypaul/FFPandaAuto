 ...
 */
public class IOSPageProfileEditEducationDeleteConfirmWin extends IOSPageTemplate {
    ...
    public IOSPageProfileEditEducationDeleteConfirmWin(IOSDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public IOSPageProfileEditEducationDeleteConfirmWin(IOSDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public IOSPageProfileEditEducationDeleteConfirmWin(String theFile, IOSDriver theD, Log theLogger) throws Exception {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            IOSPageProfileEditEducationDeleteConfirmWin x = new IOSPageProfileEditEducationDeleteConfirmWin("/PageXML/AND/bProfileEditPublication.xml", driver, null);
