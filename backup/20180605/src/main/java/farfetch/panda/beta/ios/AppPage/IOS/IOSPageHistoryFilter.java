 ...
 */
public class IOSPageHistoryFilter extends IOSPageTemplate {
    ...
    public IOSPageHistoryFilter(IOSDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public IOSPageHistoryFilter(IOSDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public IOSPageHistoryFilter(String theFile, IOSDriver theD, Log theLogger) throws Exception {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            IOSPageHistoryFilter x = new IOSPageHistoryFilter("/PageXML/AND/bPageProfileEdit.xml", driver, null);
