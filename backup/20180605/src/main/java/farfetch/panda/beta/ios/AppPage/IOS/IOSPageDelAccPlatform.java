 ...
 */
public class IOSPageDelAccPlatform extends IOSPageTemplate {
    protected String fileName = "DelAccPlatform.json";
    ...
    public IOSPageDelAccPlatform(IOSDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public IOSPageDelAccPlatform(IOSDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public IOSPageDelAccPlatform(String theFile, IOSDriver theD, Log theLogger) throws Exception {
    ...
    public String calendarOperation(IOSDriver driver, String eleName) throws Exception {
        String result = null;
        System.out.println("    +++ ~~~ The calendarOperation in IOSPageHistoryFilter has been called ~~~ +++");
        try {
    ...
    public String calendarOperationDate(IOSDriver driver, String eleName, String tDate) throws Exception {
        String result = null;
        System.out.println("    +++ ~~~ The calendarOperationDate in IOSPageHistoryFilter has been called ~~~ +++");
        try {
    ...
    public String itemListOperation(IOSDriver driver, String eleName) throws Exception {
        ...
        System.out.println("    +++ ~~~ The itemListOperation in IOSPageHistoryFilter has been called ~~~ +++");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            IOSPageDelAccPlatform x = new IOSPageDelAccPlatform("/PageXML/AND/bPageProfileEdit.xml", driver, null);
