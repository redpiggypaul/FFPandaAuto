 ...
 */
public class IOSPageNaviConfirmWin extends IOSPageTemplate {
    protected String fileName = "NaviConfirmWin.json";
    ...
    public IOSPageNaviConfirmWin(IOSDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public IOSPageNaviConfirmWin(IOSDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public IOSPageNaviConfirmWin(String theFile, IOSDriver theD, Log theLogger) throws Exception {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            IOSPageNaviConfirmWin x = new IOSPageNaviConfirmWin("/PageXML/AND/loginPage.xml", driver, null);
