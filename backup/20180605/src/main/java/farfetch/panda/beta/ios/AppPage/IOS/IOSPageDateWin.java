 ...
 */
public class IOSPageDateWin extends IOSPageTemplate {
    protected String fileName = "DateWin.json";
    ...
    public IOSPageDateWin(IOSDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public IOSPageDateWin(IOSDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public IOSPageDateWin(String theFile, IOSDriver theD, Log theLogger) throws Exception {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            IOSPageDateWin x = new IOSPageDateWin("/PageXML/AND/bProfileEditPublication.xml", driver, null);
