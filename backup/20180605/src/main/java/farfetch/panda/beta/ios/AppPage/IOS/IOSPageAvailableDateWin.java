 ...
 */
public class IOSPageAvailableDateWin extends IOSPageTemplate {
    protected String fileName = "AvailableDateWin.json";
    ...
    private static String logSpace4thisPage = " --- IOSPageAvailableDateWin --";
    ...
    public IOSPageAvailableDateWin(IOSDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public IOSPageAvailableDateWin(IOSDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public IOSPageAvailableDateWin(String theFile, IOSDriver theD, Log theLogger) throws Exception {
    ...
    public String btnOperationRoute(IOSDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperationRoute in IOSPageAvailableDateWin has been called ~~~ +++");
    ...
    public HashMap<String, By> getByMap(IOSDriver driver) {
        ...
        result.clear();
        By tempElement = null;
        System.out.println(logSpace4thisPage + "xxxxxx ------ Check the driver in IOSPageAvailableDateWin . getByMap (IOSDriver driver)  : " + driver.toString());
    ...
    public HashMap<String, By> getByMap(IOSDriver driver, HashMap<String, ElementMapping> eleMap) {
        ...
        result.clear();
        By tempElement = null;
        System.out.println(logSpace4thisPage + "xxxxxx ------ Check the driver in IOSPageAvailableDateWin . getByMap (IOSDriver driver, HashMap<String, ElementMapping> eleMap)  : " + driver.toString());
    ...
    public void btnOperation(IOSDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperation in IOSPageAvailableDateWin has been called ~~~ +++");
    ...
    public void textOperation(IOSDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperation in IOSPageAvailableDateWin has been called ~~~ +++");
    ...
    public String getElementContent(IOSDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The getElementContent in IOSPageAvailableDateWin has been called ~~~ +++");
    ...
    public String textOperationWithSaveInput(IOSDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperationWithSaveInput in IOSPageAvailableDateWin has been called ~~~ +++");
        ...
        try {
            ...
            System.out.println(logSpace4thisPage + "In IOSPageAvailableDateWin . textOperationWithSaveInput , Other Error appear : " + e.getCause());
            e.printStackTrace();
        } finally {
            return result;
        }
    ...
    public void moveUP(IOSDriver dr) throws Exception {
        System.out.println(" moveUP in IOSPageAvailableDateWin ");
        super.moveUPtest(dr);
    }

    public void moveUPall(IOSDriver dr) throws Exception {
        System.out.println(" moveUPall in IOSPageAvailableDateWin ");
        super.moveUPall(dr);
    }

    public void moveDOWN(IOSDriver dr) throws Exception {
        System.out.println(" moveDown in IOSPageAvailableDateWin ");
    ...
    public String comPageCheck(IOSDriver theD, String type4check, String para4check) {  // type4check : ready, loading, error, temp , etc.  , para4check: target element name, all element, title element
        String result = null;
        System.out.println("comPageCheck in IOSPageAvailableDateWin");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            IOSPageAvailableDateWin x = new IOSPageAvailableDateWin("/PageXML/AND/bProfileEditPublication.xml", driver, null);
