 ...
 */
public class IOSPageProjectTimeCode extends IOSPageTemplate {
    protected String fileName = "ProjectTimeCode.json";
    ...
    public IOSPageProjectTimeCode(IOSDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public IOSPageProjectTimeCode(IOSDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public IOSPageProjectTimeCode(String theFile, IOSDriver theD, Log theLogger) throws Exception {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            IOSPageProjectTimeCode x = new IOSPageProjectTimeCode("/PageXML/AND/loginPage.xml", driver, null);
