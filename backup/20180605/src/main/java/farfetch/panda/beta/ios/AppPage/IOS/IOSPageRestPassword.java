 ...
 */
public class IOSPageRestPassword extends IOSPageTemplate {
    protected String fileName = "RestPassword.json";
    ...
    private static String logSpace4thisPage = " --- RestPassword --";
    ...
    public IOSPageRestPassword(IOSDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public IOSPageRestPassword(IOSDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public IOSPageRestPassword(String theFile, IOSDriver theD, Log theLogger) throws Exception {
    ...
    public HashMap<String, By> getByMap(IOSDriver driver) {
        ...
        result.clear();
        By tempElement = null;
        System.out.println(logSpace4thisPage + "xxxxxx ------ Check the driver in RestPassword . getByMap(IOSDriver driver)   : " + driver.toString());
    ...
    public HashMap<String, By> getByMap(IOSDriver driver, HashMap<String, ElementMapping> eleMap) {
        ...
        result.clear();
        By tempElement = null;
        System.out.println(logSpace4thisPage + "xxxxxx ------ Check the driver in RestPassword . getByMap (IOSDriver driver, HashMap<String, ElementMapping> eleMap)  : " + driver.toString());
    ...
    public String btnOperationRoute(IOSDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperationRoute in RestPassword has been called ~~~ +++");
        ...
        if (!eleName.equalsIgnoreCase("PageTitle")) {
            if (movecheckdisable == false) {
                ...
                if (moveable == false) {
                    return super.btnOperationHome(driver, eleName, this.byMap, this.eleContentMap, this.content.eleTextContentMap, this.path4Log);
                } else {
                    return super.btnOperation(driver, eleName, this.byMap, this.eleContentMap, this.content.eleTextContentMap);
                }
            }
    ...
    public String textOperationWithSaveInput(IOSDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperationWithSaveInputn in IOSPageRestPassword has been called ~~~ +++");
            ...
            if (movecheckdisable == false) {
                ...
                if (moveable == false) {
                    if (eleType.equalsIgnoreCase("xpath")) {
                        resultText = super.textOperationStaticWithValueSendKey(driver, eleName, para1, this.byMap, this.content.eleDefaultValueMap, this.path4Log);
    ...
    public void btnOperation(IOSDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperation in RestPassword has been called ~~~ +++");
        boolean movecheckdisable = this.content.getFlag4MoveCheck();
        boolean moveable = this.content.getMoveable();
        boolean localMoveable = false;
        if (!eleName.equalsIgnoreCase("PageTitle")) {
    ...
    public boolean confirmOperation(IOSDriver driver) throws Exception {
        System.out.println("    +++ ~~~ The confirmOperation in RestPassword has been called ~~~ +++");
    ...
    public void textOperation(IOSDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperationn in RestPassword has been called ~~~ +++");
        //super.textOperation(driver, eleName, para1, this.byMap, this.content.eleDefaultValueMap);
        boolean movecheckdisable = this.content.getFlag4MoveCheck();
        boolean moveable = this.content.getMoveable();
        boolean localMoveable = false;
        if (!eleName.equalsIgnoreCase("PageTitle")) {
            if (movecheckdisable == false) {
                ...
                if (localMoveable == true) {
                    //super.btnOperation(driver, eleName, this.byMap, this.eleContentMap, this.content.eleTextContentMap);
                    super.textOperationSendkey(driver, eleName, para1, this.byMap, this.content.eleDefaultValueMap);
                } else {
                    super.textOperationStaticWithValueSendKey(driver, eleName, para1, this.byMap, this.content.eleDefaultValueMap, this.path4Log);
                }
            } else {
                if (moveable == false) {
                    super.textOperationStaticSendkey(driver, eleName, para1, this.byMap, this.content.eleDefaultValueMap, this.path4Log);
                } else {
                    //super.btnOperation(driver, eleName, this.byMap, this.eleContentMap, this.content.eleTextContentMap);
                    super.textOperationSendkey(driver, eleName, para1, this.byMap, this.content.eleDefaultValueMap);
                }
            ...
            super.textOperationStaticLogin(driver, eleName, para1, this.byMap, this.content.eleDefaultValueMap, this.path4Log);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            IOSPageRestPassword x = new IOSPageRestPassword("/PageXML/AND/loginPage.xml", driver, null);
