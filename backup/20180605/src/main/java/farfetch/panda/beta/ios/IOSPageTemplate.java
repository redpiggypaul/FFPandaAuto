...
public abstract class IOSPageTemplate {
    ...
    protected HashMap<String, FFPandaElementEntity> eleContentMap = null;
...
/*
    ...
    */
    ...
    public void textOperationSendkey(IOSDriver driver, StringBuilder eleName, StringBuilder para1, HashMap<String, By> inMap, HashMap<String, String> dValueMap) throws Exception {
        String dValue = null;
        IOSElement theResult = null;
        final StringBuilder localPath = this.path4Log;
        try {
    ...
    public void textOperation(IOSDriver driver, StringBuilder eleName, StringBuilder para1, HashMap<String, By> inMap, HashMap<String, String> dValueMap) throws Exception {
        String dValue = null;
        IOSElement theResult = null;
        final StringBuilder localPath = this.path4Log;
        try {
    ...
    public void textOperationSmart(IOSDriver driver, StringBuilder eleName, StringBuilder para1, HashMap<String, By> inMap, HashMap<String, String> dValueMap, final StringBuilder tText) throws Exception {
        String dValue = null;
        IOSElement theResult = null;
        final StringBuilder localPath = this.path4Log;
        try {
    ...
    public StringBuilder textOperationSmartSaveInput(IOSDriver driver, StringBuilder eleName, StringBuilder para1, HashMap<String, By> inMap,
                                                     HashMap<String, String> dValueMap, final StringBuilder path) throws Exception {
        StringBuilder result = new StringBuilder();
        IOSElement theResult = null;
    ...
    public StringBuilder textOperationWithSaveInput(IOSDriver driver, StringBuilder eleName, StringBuilder para1, HashMap<String, By> inMap) throws Exception {
        StringBuilder result = new StringBuilder();
        WebElement theResult = null;
        final StringBuilder localPath = this.path4Log;
        try {
    ...
    public String autoCompleteOperationSuper(IOSDriver driver, String
            eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, String p4L, String tDate, String autoCompleteWin) throws Exception {
        StringBuilder result = new StringBuilder();
    ...
    public String autoCompleteStartMAC(IOSDriver driver, String eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, final StringBuilder p4L, String dValue, String extPara) throws Exception {
        StringBuilder result = new StringBuilder();
        IOSElement theResult = null;
        Thread.sleep(1000);
    ...
    public String selectCompareItemMAC(IOSDriver driver, String eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, final StringBuilder p4L, String extPara, Boolean contentIsolatedClickable) throws Exception {  //TODO
        StringBuilder result = new StringBuilder();
        ...
        try {
            ...
            for (Iterator it = inMap.entrySet().iterator(); it.hasNext() && theResult == null; ) {
                ...
                if (tempContentEntry.getKey().toString().equalsIgnoreCase(eleName)) {
                    ...
                    result = new StringBuilder(theResult.getText());
                    if (eleName.toLowerCase().contains("phone")) {
                        result = new StringBuilder(result.replaceAll("-", ""));
                    }
                    break;
                }
            }
    ...
    public StringBuilder getElementContent(IOSDriver driver, StringBuilder
        ...
        try {
            ...
            for (int ind = 0; (ind <= steprange) && (theResult == null); ind++) {
                ...
                locatorStr = new StringBuilder(locatorStr.toString().replaceFirst(":REXindex:", stepINString));
                ...
                if (tempContentEntry.getKey().toString().equalsIgnoreCase(eleName.toString())) {
                    ...
                    theResult = xWait.until(new IOSExpectedCondition<WebElement>() {
                        public WebElement apply(IOSDriver driver) {
                            WebElement temp = null;
                            try {
                                temp = findElementWithSearch(driver, (By) tempContentEntry.getValue(), Integer.parseInt(String.valueOf(timeOutInSeconds * 1000)), localPath.toString());
                            } catch (Exception e) {
                                throw new TimeoutException(e.getMessage());
                            }
                            return temp;
...
// TODO make following loop quit with suitable reason
    ...
    public String selectItemMAC(IOSDriver driver, String eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, final StringBuilder p4L, String extPara, Boolean contentIsolatedClickable) throws Exception {  //TODO
        StringBuilder result = new StringBuilder();
        List<WebElement> theResultList = new ArrayList<WebElement>();
        WebElement choosedItem = null;
        Thread.sleep(2500);
    ...
    public String btnOperation(IOSDriver driver, String eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, String p4L) throws Exception {
        StringBuilder result = new StringBuilder();
        IOSElement theResult = null;
        Thread.sleep(1000);
        final StringBuilder localPath = p4L;
    ...
    public String btnOperation(IOSDriver driver, String eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, String p4L, HashMap<String, String> textMap) throws Exception {
        StringBuilder result = new StringBuilder();
        IOSElement theResult = null;
        final StringBuilder localPath = p4L;
        try {
    ...
    public String btnOperationDync(IOSDriver driver, String eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, String p4L, HashMap<String, String> textMap, Boolean movedheckdisable, Boolean moveable) throws Exception {
        StringBuilder result = new StringBuilder();
        IOSElement theResult = null;
    ...
    public String btnOperationListMatch(IOSDriver driver, String eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, String p4L) throws Exception {
        StringBuilder result = new StringBuilder();
        List<WebElement> theResult = null;
        Thread.sleep(1000);
        final StringBuilder localPath = p4L;
    ...
    public String btnOperationAutoIndex(IOSDriver driver, String eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, String p4L) throws Exception {   //TODO
        StringBuilder result = new StringBuilder();
        Thread.sleep(1000);
        final StringBuilder localPath = p4L;
        int index4item = 1;
    ...
    public String getElementContentSmart(IOSDriver driver, String locatorStr, String locatorType, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, String p4L, int TITLEindex) throws Exception {
        StringBuilder result = new StringBuilder();
        List<WebElement> eleList = new ArrayList<WebElement>();
    ...
    public String getStaticElementContent(IOSDriver driver, String locatorStr, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, String p4L, int TITLEindex) throws Exception {
        StringBuilder result = new StringBuilder();
        String localStr = null;
        Thread.sleep(1000);
        int steprange = 3;
    ...
    public String autoSearch(IOSDriver driver, String eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, String p4L) throws Exception {
        StringBuilder result = new StringBuilder();
        WebElement theResult = null;
        Thread.sleep(1000);
        final StringBuilder localPath = p4L;
    ...
    private IOSElement filterBtnElement(IOSDriver driver, IOSDriverWait xWait, By theByKey, String eleName, HashMap<String, FFPandaElementEntity> eleMap, int extindex4path) throws Exception {
        ...
        try {
            for (Iterator it = eleMap.entrySet().iterator(); it.hasNext(); ) {  // find the xpath of the element in map  去找这个元素在xml内的
                final Map.Entry tempContentEntry = (Map.Entry) it.next();
                if (tempContentEntry.getKey().toString().equalsIgnoreCase(eleName)) {
                    String tempXpath = ((FFPandaElementEntity) tempContentEntry.getValue()).getLocatorStr();  // xpath内容找到
            ...
            if (targetXPATH_start != "") {
                for (Iterator it = eleMap.entrySet().iterator(); it.hasNext(); ) {  // find the xpath of the element in map
                    ...
                    if (tempContentEntry.getKey().toString().equalsIgnoreCase(eleName + "Btn")) {   // 注意格式
                        String tempXpath = ((FFPandaElementEntity) tempContentEntry.getValue()).getLocatorStr();
    ...
    private IOSElement filterBtnElementOLD(IOSDriver driver, IOSDriverWait xWait, By theByKey, String eleName, HashMap<String, FFPandaElementEntity> eleMap) throws Exception {
        boolean review = false;
        int moveAccount = 10;
        IOSElement result = null;
        List<IOSElement> temp = new ArrayList<IOSElement>();
    ...
    private int getIndex4BtnElement(IOSDriver driver, IOSDriverWait xWait, By theByKey, String eleName, HashMap<String, FFPandaElementEntity> eleMap) throws Exception {
        boolean review = false;
        int moveAccount = 10;
        IOSElement result = null;
        List<IOSElement> temp = new ArrayList<IOSElement>();
    ...
    private IOSElement filterRecordElement(IOSDriver driver, IOSDriverWait xWait, By theByKey, String eleName, HashMap<String, FFPandaElementEntity> eleMap) throws Exception {
        boolean review = false;
        int moveAccount = 10;
        IOSElement result = null;
        List<IOSElement> temp = new ArrayList<IOSElement>();
    ...
    public String btnOperationSearch(IOSDriver driver, String eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, String p4L, int index4xpath) throws Exception {
        StringBuilder result = new StringBuilder();
        IOSElement theResult = null;
        Thread.sleep(500);
        final StringBuilder localPath = p4L;
    ...
    public String isolatedBtnSearchWithIndex(IOSDriver driver, final String eleName, final String comType, final String comStr, final HashMap<String, By> inMap,
                                             final HashMap<String, FFPandaElementEntity> eleMap, String p4L, int ind4xpath, HashMap<String, String> textMap,
    ...
    public int getIndex4TitleIndex(IOSDriver driver, String eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, String p4L, int index4xpath) throws Exception, InterruptedException {
        StringBuilder result = new StringBuilder();
        Thread.sleep(500);
        final StringBuilder localPath = p4L;
        try {
    ...
    public String recordSearch(IOSDriver driver, String eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, String p4L, int index4path, String type, String rowLocatorString, String recordType, String recordLocatorStr, HashMap<String, Integer> waitStepMap) throws Exception {
        StringBuilder result = new StringBuilder();
        IOSElement theResult = null;
        Thread.sleep(500);
        final StringBuilder localPath = p4L;
    ...
    public String btnMatchSearchByValue(IOSDriver driver, String eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, String p4L, int index4path, String type, String rowLocatorString, String recordType, String recordLocatorStr, HashMap<String, Integer> waitStepMap, String key) throws Exception {
        StringBuilder result = new StringBuilder();
        IOSElement theResult = null;
    ...
    public String contentMatchSearchByValue(IOSDriver driver, String eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, String p4L, int index4path, String type, String rowLocatorString, String recordType, String recordLocatorStr, HashMap<String, Integer> waitStepMap, String key) throws Exception {
        StringBuilder result = new StringBuilder();
        IOSElement theResult = null;
        IOSElement theRecord = null;
        List<IOSElement> theMapValueList = new ArrayList<IOSElement>();
    ...
    public String rollTheRound(IOSDriver driver, String
            eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, int currentDayInt, int roundRange, boolean direction) throws Exception {
    ...
    //TODO
    public String getElementContent(IOSDriver driver, String
            eleName, String eleType, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, HashMap<String, String> textMap) throws
            Exception {
        WebElement theResult = null;
        List<WebElement> eleList = new ArrayList<WebElement>();
        StringBuilder result = new StringBuilder();
    ...
    public String comPageCheckWithInstanceInfo(IOSDriver theD, String type4check, String para4check, FFPandaIOSPageContent inContent, HashMap<String, FFPandaElementEntity> inEleContentMap, HashMap<String, By> inByMap) {  // type4check : ready, loading, error, temp , etc.  , para4check: target element name, all element, title element
        StringBuilder result = new StringBuilder();
        boolean flag = false;
        String eleText = null;
        try {
    ...
    public String comPageCheck(IOSDriver theD, String type4check, String para4check, FFPandaFFPandaIOSPageContent
    ...
    public boolean tableMatch(IOSDriver driver, String
            eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, String p4L,
    ...
    public String recordSearch(IOSDriver driver, String
            eleName, HashMap<String, FFPandaElementEntity> eleMap, String p4L, int index4path, String type, String
