 ...
 */
public class IOSPageProfileEditWorkExp extends IOSPageTemplate {
    protected String fileName = "ProfileEditWorkExp.json";
    ...
    private String dateWin = "YandMDateWin";
    ...
    private static String logSpace4thisPage = " --- IOSPageProfileEditWorkExp --";
    ...
    public IOSPageProfileEditWorkExp(IOSDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public IOSPageProfileEditWorkExp(IOSDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public IOSPageProfileEditWorkExp(String theFile, IOSDriver theD, Log theLogger) throws Exception {
    ...
    public HashMap<String, By> getByMap(IOSDriver driver) {
        ...
        result.clear();
        By tempElement = null;
        System.out.println(logSpace4thisPage + "xxxxxx ------ Check the driver in IOSPageProfileEditWorkExp . getByMap(IOSDriver driver)   : " + driver.toString());
    ...
    public HashMap<String, By> getByMap(IOSDriver driver, HashMap<String, ElementMapping> eleMap) {
        ...
        result.clear();
        By tempElement = null;
        System.out.println(logSpace4thisPage + "xxxxxx ------ Check the driver in IOSPageProfileEditWorkExp . getByMap (IOSDriver driver, HashMap<String, ElementMapping> eleMap)  : " + driver.toString());
    ...
    public String btnOperationRoute(IOSDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperationRoute in IOSPageProfileEditWorkExp has been called ~~~ +++");
    ...
    public void btnOperation(IOSDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperation in IOSPageProfileEditWorkExp has been called ~~~ +++");
    ...
    public String getElementContent(IOSDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The getElementContent in IOSPageProfileEditWorkExp has been called ~~~ +++");
        boolean movecheckdisable = this.content.getFlag4MoveCheck();
        boolean moveable = this.content.getMoveable();
        boolean localMoveable = false;
        String result = null;
    ...
    public String textOperationWithSaveInput(IOSDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperationWithSaveInputn in IOSPageProfileEditWorkExp has been called ~~~ +++");
    ...
    public String calendarOperation(IOSDriver driver, String eleName) throws Exception {
        String result = null;
        System.out.println("    +++ ~~~ The calendarOperation in IOSPageProfileEditWorkExp has been called ~~~ +++");
        try {
    ...
    public String calendarOperationDate(IOSDriver driver, String eleName, String tMonth) throws Exception {
        String result = null;
        System.out.println("    +++ ~~~ The calendarOperationDate in IOSPageProfileEditWorkExp has been called ~~~ +++");
        try {
            result = super.calendarOperationYandM(driver, eleName, this.byMap, this.eleContentMap, this.path4Log, tMonth, this.dateWin);
            return result;
        } catch (Exception e) {
            throw e;
        }
    ...
    public String searchOperation(IOSDriver driver, String eleName, String extPara) throws Exception {  //TODO
        ...
        System.out.println("    +++ ~~~ The searchOperation in IOSPageProfileEditWorkExp has been called ~~~ +++");
        System.out.println(" this time we want to choose the " + extPara + " item ");
        ...
        if (selectItemValue != null && selectItemValue != "") {
            ...
            System.out.println("Error appear with searchOperation IN IOSPageProfileEditWorkExp");
            throw new REXException("Error appear with searchOperation IN IOSPageProfileEditWorkExp");
        }
    }

    public String autoCompleteOperation(IOSDriver driver, String eleName, String extPara) throws Exception {  //TODO
        String result = null;
        System.out.println("    +++ ~~~ The autoCompleteOperation in IOSPageProfileEditWorkExp has been called ~~~ +++");
        System.out.println(" this time we want to choose the " + extPara + " item ");
        try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            IOSPageProfileEditWorkExp x = new IOSPageProfileEditWorkExp("/PageXML/AND/loginPage.xml", driver, null);
