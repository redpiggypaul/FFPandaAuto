 ...
 */
public class IOSPageProjectExpenseCode extends IOSPageTemplate {
    protected String fileName = "ProjectExpenseCode.json";
    ...
    private static String logSpace4thisPage = " --- IOSPageProfileEditSkill --";
    ...
    public IOSPageProjectExpenseCode(IOSDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public IOSPageProjectExpenseCode(IOSDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public IOSPageProjectExpenseCode(String theFile, IOSDriver theD, Log theLogger) throws Exception {
    ...
    public void moveUP(IOSDriver dr) throws Exception {
        System.out.println(" moveUP in IOSPageProfileEditSkill ");
        super.moveUPtest(dr);
    }


    public void moveDown(IOSDriver dr) throws Exception {
        System.out.println(" moveDown in IOSPageProfileEditSkill ");
    ...
    public HashMap<String, By> getByMap(IOSDriver driver) {
        ...
        result.clear();
        By tempElement = null;
        System.out.println(logSpace4thisPage + "xxxxxx ------ Check the driver in IOSPageProfileEditSkill . getByMap(IOSDriver driver)   : " + driver.toString());
    ...
    public HashMap<String, By> getByMap(IOSDriver driver, HashMap<String, ElementMapping> eleMap) {
        ...
        result.clear();
        By tempElement = null;
        System.out.println(logSpace4thisPage + "xxxxxx ------ Check the driver in IOSPageProfileEditSkill . getByMap (IOSDriver driver, HashMap<String, ElementMapping> eleMap)  : " + driver.toString());
    ...
    public String btnOperationRoute(IOSDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperationRoute in IOSPageProfileEditSkill has been called ~~~ +++");
    ...
    public void btnOperation(IOSDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperation in IOSPageProfileEditSkill has been called ~~~ +++");
        boolean movecheckdisable = this.content.getFlag4MoveCheck();
        boolean moveable = this.content.getMoveable();
        boolean localMoveable = false;
        if (!eleName.equalsIgnoreCase("PageTitle")) {
    ...
    public void textOperation(IOSDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperation in IOSPageProfileEditSkill has been called ~~~ +++");
        boolean movecheckdisable = this.content.getFlag4MoveCheck();
        boolean moveable = this.content.getMoveable();
        boolean localMoveable = false;
        if (!eleName.equalsIgnoreCase("PageTitle")) {
    ...
    public String searchOperation(IOSDriver driver, String eleName, String extPara) throws Exception {  //TODO
        ...
        System.out.println("    +++ ~~~ The searchOperation in IOSPageProfileEditSkill has been called ~~~ +++");
        ...
        if (selectItemValue != null && selectItemValue != "") {
            ...
            System.out.println("Error appear with searchOperation IN IOSPageProfileEditSkill");
            throw new REXException("Error appear with searchOperation IN IOSPageProfileEditSkill");
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            IOSPageProjectExpenseCode x = new IOSPageProjectExpenseCode("/PageXML/AND/loginPage.xml", driver, null);
