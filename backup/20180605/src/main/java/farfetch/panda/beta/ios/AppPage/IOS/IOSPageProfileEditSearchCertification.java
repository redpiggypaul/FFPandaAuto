 ...
 */
public class IOSPageProfileEditSearchCertification extends IOSPageTemplate {
    protected String fileName = "ProfileEditSearchCertification.json";
    ...
    private static String logSpace4thisPage = " --- IOSPageProfileEditSearchCertification --";
    ...
    public IOSPageProfileEditSearchCertification(IOSDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public IOSPageProfileEditSearchCertification(IOSDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public IOSPageProfileEditSearchCertification(String theFile, IOSDriver theD, Log theLogger) throws Exception {
    ...
    public void moveUP(IOSDriver dr) throws Exception {
        System.out.println(" moveUP in IOSPageProfileEditSearchCertification ");
        super.moveUPtest(dr);
    }


    public void moveDown(IOSDriver dr) throws Exception {
        System.out.println(" moveDown in IOSPageProfileEditSearchCertification ");
    ...
    public HashMap<String, By> getByMap(IOSDriver driver) {
        ...
        result.clear();
        By tempElement = null;
        System.out.println(logSpace4thisPage + "xxxxxx ------ Check the driver in IOSPageProfileEditSearchCertification . getByMap(IOSDriver driver)   : " + driver.toString());
    ...
    public HashMap<String, By> getByMap(IOSDriver driver, HashMap<String, ElementMapping> eleMap) {
        ...
        result.clear();
        By tempElement = null;
        System.out.println(logSpace4thisPage + "xxxxxx ------ Check the driver in IOSPageProfileEditSearchCertification . getByMap (IOSDriver driver, HashMap<String, ElementMapping> eleMap)  : " + driver.toString());
    ...
    public String btnOperationRoute(IOSDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperationRoute in IOSPageProfileEditSearchCertification has been called ~~~ +++");
    ...
    public void btnOperation(IOSDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperation in IOSPageProfileEditSearchCertification has been called ~~~ +++");
        boolean movecheckdisable = this.content.getFlag4MoveCheck();
        boolean moveable = this.content.getMoveable();
        boolean localMoveable = false;
        if (!eleName.equalsIgnoreCase("PageTitle")) {
    ...
    public void textOperation(IOSDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperation in IOSPageProfileEditSearchCertification has been called ~~~ +++");
        boolean movecheckdisable = this.content.getFlag4MoveCheck();
        boolean moveable = this.content.getMoveable();
        boolean localMoveable = false;
        if (!eleName.equalsIgnoreCase("PageTitle")) {
    ...
    public String searchOperation(IOSDriver driver, String eleName, String extPara) throws Exception {  //TODO
        ...
        System.out.println("    +++ ~~~ The searchOperation in IOSPageProfileEditSearchCertification has been called ~~~ +++");
        ...
        if (selectItemValue != null && selectItemValue != "") {
            ...
            System.out.println("Error appear with searchOperation IN IOSPageProfileEditSearchCertification");
            throw new REXException("Error appear with searchOperation IN IOSPageProfileEditSearchCertification");
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            IOSPageProfileEditSearchCertification x = new IOSPageProfileEditSearchCertification("/PageXML/AND/loginPage.xml", driver, null);
