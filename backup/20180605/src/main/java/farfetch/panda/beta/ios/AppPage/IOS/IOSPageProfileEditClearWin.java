 ...
 */
public class IOSPageProfileEditClearWin extends IOSPageTemplate {
    protected String fileName = "ProfileEditClearWin.json";
    ...
    private static String logSpace4thisPage = " --- bANDPageLogin --";
    ...
    public IOSPageProfileEditClearWin(IOSDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public IOSPageProfileEditClearWin(IOSDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public IOSPageProfileEditClearWin(String theFile, IOSDriver theD, Log theLogger) throws Exception {
    ...
    public HashMap<String, By> getByMap(IOSDriver driver) {
        ...
        result.clear();
        By tempElement = null;
        System.out.println(logSpace4thisPage + "xxxxxx ------ Check the driver in bANDPageLogin . getByMap(IOSDriver driver)   : " + driver.toString());
    ...
    public HashMap<String, By> getByMap(IOSDriver driver, HashMap<String, ElementMapping> eleMap) {
        ...
        result.clear();
        By tempElement = null;
        System.out.println(logSpace4thisPage + "xxxxxx ------ Check the driver in bANDPageLogin . getByMap (IOSDriver driver, HashMap<String, ElementMapping> eleMap)  : " + driver.toString());
    ...
    public void btnOperation(IOSDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperation in bANDPageLogin has been called ~~~ +++");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            IOSPageProfileEditClearWin x = new IOSPageProfileEditClearWin("/PageXML/AND/loginPage.xml", driver, null);
