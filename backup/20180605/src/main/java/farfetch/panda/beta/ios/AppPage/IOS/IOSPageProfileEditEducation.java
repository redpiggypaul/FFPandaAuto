...
public class IOSPageProfileEditEducation extends IOSPageTemplate {
    ...
    public String calendarOperationDateYandM(IOSDriver driver, String eleName, String tDate) throws Exception {
        String result = null;
        System.out.println("    +++ ~~~ The calendarOperationDateYandM in IOSPageProfileEditEducation has been called ~~~ +++");
        try {
            result = super.calendarOperationYandM(driver, eleName, this.byMap, this.eleContentMap, this.path4Log, tDate, this.dateWin);
            return result;
        } catch (Exception e) {
            throw e;
        }
