 ...
 */
public class IOSPageHome extends IOSPageTemplate {
    protected String fileName = "homePage.json";
    ...
    public IOSPageHome(IOSDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public IOSPageHome(IOSDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public IOSPageHome(String theFile, IOSDriver theD, Log theLogger) throws Exception {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            IOSPageHome x = new IOSPageHome("/PageXML/AND/loginPage.xml", driver, null);
