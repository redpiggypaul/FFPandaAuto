...
import static Component.PageLoadWait.REXDriverWait.combindAndElement;
import static utility.XmlUtils.readANDXMLDocument;

/**
 * Created by appledev131 on 4/12/16.
 */
public class ANDBasePageContent extends AppBasePageContent {
    ...
    private static String logSpace4thisPage = " --- ANDBasePageContent ---";

    public ANDBasePageContent(AndroidDriver dr, String path) throws Exception {
        super(dr, path);
    ...
    public ANDBasePageContent(String path) throws Exception {
    ...
    public static void main(String args[]) {
        try {
            ...
            try {
                ...
                ANDBasePageContent x = new ANDBasePageContent(dr, path);
