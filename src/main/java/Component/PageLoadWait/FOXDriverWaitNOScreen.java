 ...
 */
public class FOXDriverWaitNOScreen extends FluentWait<WebDriver> {
     ...
     * @see FOXDriverWaitNOScreen#ignoring(Class)
     */
    public FOXDriverWaitNOScreen(WebDriver driver, long timeOutInSeconds) throws Exception{
     ...
     * @see FOXDriverWaitNOScreen#ignoring(Class)
     */
    public FOXDriverWaitNOScreen(WebDriver driver, long timeOutInSeconds, long sleepInMillis) throws Exception{
     ...
     */
    public FOXDriverWaitNOScreen(WebDriver driver, Clock clock, Sleeper sleeper, long timeOutInSeconds,
