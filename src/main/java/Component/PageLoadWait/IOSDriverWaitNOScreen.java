 ...
 */
public class IOSDriverWaitNOScreen extends FluentWait<IOSDriver> {
     ...
     * @see IOSDriverWaitNOScreen#ignoring(Class)
     */
    public IOSDriverWaitNOScreen(IOSDriver driver, long timeOutInSeconds) throws Exception{
     ...
     * @see IOSDriverWaitNOScreen#ignoring(Class)
     */
    public IOSDriverWaitNOScreen(IOSDriver driver, long timeOutInSeconds, long sleepInMillis) throws Exception{
     ...
     */
    public IOSDriverWaitNOScreen(IOSDriver driver, Clock clock, Sleeper sleeper, long timeOutInSeconds,
