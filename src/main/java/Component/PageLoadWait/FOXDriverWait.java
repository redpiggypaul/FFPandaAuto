 ...
 */
public class FOXDriverWait extends FluentWait<WebDriver> {
     ...
     * @see FOXDriverWait#ignoring(Class)
     */
    public FOXDriverWait(WebDriver driver, long timeOutInSeconds) throws Exception {
        this(driver, new SystemClock(), Sleeper.SYSTEM_SLEEPER, timeOutInSeconds, DEFAULT_SLEEP_TIMEOUT);
    }

    public FOXDriverWait(WebDriver driver, long timeOutInSeconds, String p4L) throws Exception {
        this(driver, new SystemClock(), Sleeper.SYSTEM_SLEEPER, timeOutInSeconds, DEFAULT_SLEEP_TIMEOUT, p4L);
    }

    public FOXDriverWait(WebDriver driver, long timeOutInSeconds, String p4L, boolean theFlag) throws Exception {
     ...
     * @see FOXDriverWait#ignoring(Class)
     */
    public FOXDriverWait(WebDriver driver, long timeOutInSeconds, long sleepInMillis) throws Exception {
     ...
     */
    public FOXDriverWait(WebDriver driver, Clock clock, Sleeper sleeper, long timeOutInSeconds,
