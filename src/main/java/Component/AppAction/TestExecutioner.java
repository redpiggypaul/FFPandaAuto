...
//    protected IOSPageNaviBar theNaviBarIOS = null;
    ...
    protected AppiumDriver targetSYSstartup(AppiumDriver driver, StringBuilder deviceType, HashMap<StringBuilder, Object> pageGroup) {
        AppiumDriver result = driver;
        try {
            StringBuilder testENVpreName = new StringBuilder();
           ...
           */
                ...
                pageGroup.put(new StringBuilder("homePage"), this.basePageIOS);
                pageGroup.put(new StringBuilder("bashPage"), this.theHomeIOS);
                pageGroup.put(new StringBuilder("NaviBar"), this.theNaviBarIOS);
            }
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
    ...
    private void testStepLooper(IOSDriver driver, ArrayList<StringBuilder> actionSequence) throws Exception {
    ...
    public IOSDriver comOperationInIOS(IOSDriver theDriver, ArrayList<StringBuilder> actionSequence, ArrayList<StringBuilder> extPara, StringBuilder deviceType) throws Exception {
        ...
        try {
            ...
            String currentOpeItemStepName4Error = "";
            String lastOpeItemStepName4Error = "";
            HashMap<StringBuilder, Object> pageGroup = new HashMap<StringBuilder, Object>();
            ...
            //然后进入常规动作循环
            testStepLooper(theDriver, actionSequence);
