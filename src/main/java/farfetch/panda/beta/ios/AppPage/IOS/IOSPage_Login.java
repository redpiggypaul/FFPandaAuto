 ...
 */
public class IOSPage_Login extends IOSPageTemplate {
    ...
    public IOSPage_Login(IOSDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public IOSPage_Login(IOSDriver theD, StringBuilder p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toString().toLowerCase().contains("windows")) {
            contentFilePath = new StringBuilder(contentFilePath.toString().replaceAll("\\\\", File.separator));
    ...
    // for dry run
    public IOSPage_Login(StringBuilder filename, StringBuilder p4L) throws Exception {
        super(filename, p4L);
        //  this.dr = theD;
        if (!autoOSType.toString().toLowerCase().contains("windows")) {
            contentFilePath = new StringBuilder(contentFilePath.toString().replaceAll("\\\\", File.separator));
    ...
    public IOSPage_Login(String theFile, IOSDriver theD, Log theLogger) throws Exception {
  ...
  //          driver = new IOSDriver(new URL(""), capabilities);
            ...
            IOSPage_Login x = new IOSPage_Login(new StringBuilder("/PageXML/IOS/IOSPage_Account.xml"), null);
