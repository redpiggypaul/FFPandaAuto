 ...
 */
public class IOSPage_FFDryRunDemo_2 extends IOSPageTemplate {
    ...
    public IOSPage_FFDryRunDemo_2(IOSDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public IOSPage_FFDryRunDemo_2(IOSDriver theD, StringBuilder p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toString().toLowerCase().contains("windows")) {
            contentFilePath = new StringBuilder(contentFilePath.toString().replaceAll("\\\\", File.separator));
    ...
    // for dry run
    public IOSPage_FFDryRunDemo_2(StringBuilder filename, StringBuilder p4L) throws Exception {
        super(filename, p4L);
        //  this.dr = theD;
        if (!autoOSType.toString().toLowerCase().contains("windows")) {
            contentFilePath = new StringBuilder(contentFilePath.toString().replaceAll("\\\\", File.separator));
    ...
    public IOSPage_FFDryRunDemo_2(String theFile, IOSDriver theD, Log theLogger) throws Exception {
    ...
    public HashMap<StringBuilder, By> getByMap(IOSDriver driver) {
        ...
        result.clear();
        By tempElement = null;
        System.out.println(logSpace4thisPage + "xxxxxx ------ Check the driver in IOSPage_FFDryRunDemo_2 . getByMap(IOSDriver driver)   : " + driver.toString());
    ...
    public HashMap<String, By> getByMap(IOSDriver driver, HashMap<StringBuilder, FFPandaElementEntity> eleMap) {
        ...
        result.clear();
        By tempElement = null;
        System.out.println(logSpace4thisPage + "xxxxxx ------ Check the driver in IOSPage_FFDryRunDemo_2 . getByMap (IOSDriver driver, HashMap<String, FFPandaElementEntity> eleMap)  : " + driver.toString());
    ...
    public StringBuilder btnOperationRoute(IOSDriver driver, StringBuilder eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperationRoute in IOSPage_FFDryRunDemo_2 has been called ~~~ +++");
    ...
    public StringBuilder btnOperationRoute_DRYRUN(String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperationRoute_DRYRUN in IOSPage_FFDryRunDemo_2 has been called ~~~ +++");
        return new StringBuilder("dryrun_btn");
    }
    ...
    public void btnOperation(IOSDriver driver, StringBuilder eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperation in IOSPage_FFDryRunDemo_2 has been called ~~~ +++");
    ...
    public void dryrun_text(String eleName, String extPara) throws Exception {
        System.out.println("    +++ ~~~ The dryrun_text in IOSPage_FFDryRunDemo_2 has been called ~~~ +++");
    }
    ...
    public void textOperation(IOSDriver driver, StringBuilder eleName, StringBuilder para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperationn in IOSPage_FFDryRunDemo_2 has been called ~~~ +++");
    ...
    public String dryrun_textfield_input(String eleName, String extPara) throws Exception {
        System.out.println("    +++ ~~~ The dryrun_textfield_input in IOSPage_FFDryRunDemo_2 has been called ~~~ +++");
        return extPara;
    }
    ...
    public StringBuilder textOperationWithSaveInput(IOSDriver driver, StringBuilder eleName, StringBuilder para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperationWithSaveInput in IOSPage_FFDryRunDemo_2 has been called ~~~ +++");
    ...
    public StringBuilder getElementContent(IOSDriver driver, StringBuilder eleName) throws Exception {
        System.out.println("    +++ ~~~ The getElementContent in IOSPage_FFDryRunDemo_2 has been called ~~~ +++");
        boolean movecheckdisable = this.content.getFlag4MoveCheck();
        boolean moveable = this.content.getMoveable();
        boolean localMoveable = false;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            */
            ...
            IOSPage_FFDryRunDemo_2 x = new IOSPage_FFDryRunDemo_2(new StringBuilder("/PageXML/IOS/FFDryRunDemo_2.xml"), null);
