 ...
 */
public class IOSPage_Home extends IOSPageTemplate {
    ...
    public IOSPage_Home(IOSDriver theD, StringBuilder p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toString().toLowerCase().contains("windows")) {
            contentFilePath = new StringBuilder(contentFilePath.toString().replaceAll("\\\\", File.separator));
    ...
    // for dry run
    public IOSPage_Home(StringBuilder filename, StringBuilder p4L) throws Exception {
        super(filename, p4L);
        //  this.dr = theD;
        if (!autoOSType.toString().toLowerCase().contains("windows")) {
            contentFilePath = new StringBuilder(contentFilePath.toString().replaceAll("\\\\", File.separator));
    ...
    public IOSPage_Home(String theFile, IOSDriver theD, Log theLogger) throws Exception {
  ...
  //          driver = new IOSDriver(new URL(""), capabilities);
            ...
            IOSPage_Home x = new IOSPage_Home(new StringBuilder("/PageXML/IOS/IOSPage_Account.xml"), null);
