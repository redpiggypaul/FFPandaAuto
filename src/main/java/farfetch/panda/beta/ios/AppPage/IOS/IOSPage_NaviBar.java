 ...
 */
public class IOSPage_NaviBar extends IOSPageTemplate {
    ...
    public IOSPage_NaviBar(IOSDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public IOSPage_NaviBar(IOSDriver theD, StringBuilder p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toString().toLowerCase().contains("windows")) {
            contentFilePath = new StringBuilder(contentFilePath.toString().replaceAll("\\\\", File.separator));
    ...
    // for dry run
    public IOSPage_NaviBar(StringBuilder filename, StringBuilder p4L) throws Exception {
        super(filename, p4L);
        //  this.dr = theD;
        if (!autoOSType.toString().toLowerCase().contains("windows")) {
            contentFilePath = new StringBuilder(contentFilePath.toString().replaceAll("\\\\", File.separator));
    ...
    public IOSPage_NaviBar(String theFile, IOSDriver theD, Log theLogger) throws Exception {
  ...
  //          driver = new IOSDriver(new URL(""), capabilities);
            ...
            IOSPage_NaviBar x = new IOSPage_NaviBar(new StringBuilder("/PageXML/IOS/IOSPage_Account.xml"), null);
