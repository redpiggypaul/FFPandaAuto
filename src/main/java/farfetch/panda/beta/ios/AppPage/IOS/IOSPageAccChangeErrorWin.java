 ...
 */
public class IOSPageAccChangeErrorWin extends IOSPageTemplate {
    protected String fileName = "AccChangeErrorWin.json";
    ...
    private static String logSpace4thisPage = " --- IOSPageAccChangeErrorWin --";
    ...
    public IOSPageAccChangeErrorWin(IOSDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public IOSPageAccChangeErrorWin(IOSDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public IOSPageAccChangeErrorWin(String theFile, IOSDriver theD, Log theLogger) throws Exception {
    ...
    public HashMap<String, By> getByMap(IOSDriver driver) {
        ...
        result.clear();
        By tempElement = null;
        System.out.println(logSpace4thisPage + "xxxxxx ------ Check the driver in IOSPageAccChangeErrorWin . getByMap(IOSDriver driver)   : " + driver.toString());
    ...
    public HashMap<String, By> getByMap(IOSDriver driver, HashMap<String, ElementMapping> eleMap) {
        ...
        result.clear();
        By tempElement = null;
        System.out.println(logSpace4thisPage + "xxxxxx ------ Check the driver in IOSPageAccChangeErrorWin . getByMap (IOSDriver driver, HashMap<String, ElementMapping> eleMap)  : " + driver.toString());
    ...
    public String btnOperationRoute(IOSDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperationRoute in IOSPageAccChangeErrorWin has been called ~~~ +++");
    ...
    public String checkAbnormalElement(IOSDriver driver, String eleName) throws REXException {
        System.out.println("    +++ ~~~ The checkAbnormalElement in bANDPageAccChangeErrorWin has been called ~~~ +++");
    ...
    public void btnOperation(IOSDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperation in IOSPageAccChangeErrorWin has been called ~~~ +++");
    ...
    public String getElementContent(IOSDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The getElementContent in IOSPageAccChangeErrorWin has been called ~~~ +++");
        String eleType = null;
        String eleText = null;
        String eleStr = null;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            IOSPageAccChangeErrorWin x = new IOSPageAccChangeErrorWin("/PageXML/AND/loginPage.xml", driver, null);
