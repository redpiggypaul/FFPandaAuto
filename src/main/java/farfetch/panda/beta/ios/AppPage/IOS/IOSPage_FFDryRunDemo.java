 ...
 */
public class IOSPage_FFDryRunDemo extends IOSPageTemplate {
    ...
    private static String logSpace4thisPage = " --- IOSPage_FFDryRunDemo --";
    ...
    public String value4compareDRYRUN() {
        return this.storeValue4compare;
    }
    ...
    public IOSPage_FFDryRunDemo(IOSDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public IOSPage_FFDryRunDemo(IOSDriver theD, StringBuilder p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toString().toLowerCase().contains("windows")) {
            contentFilePath = new StringBuilder(contentFilePath.toString().replaceAll("\\\\", File.separator));
    ...
    // for dry run
    public IOSPage_FFDryRunDemo(StringBuilder filename, StringBuilder p4L) throws Exception {
        super(filename, p4L);
        //  this.dr = theD;
        if (!autoOSType.toString().toLowerCase().contains("windows")) {
            contentFilePath = new StringBuilder(contentFilePath.toString().replaceAll("\\\\", File.separator));
    ...
    public IOSPage_FFDryRunDemo(String theFile, IOSDriver theD, Log theLogger) throws Exception {
    ...
    public void moveUP(IOSDriver dr) throws Exception {
        System.out.println(" moveUP in IOSPage_FFDryRunDemo ");
        super.moveUPtest(dr);
    }


    public void moveDown(IOSDriver dr) throws Exception {
        System.out.println(" moveDown in IOSPage_FFDryRunDemo ");
    ...
    public HashMap<StringBuilder, By> getByMap(IOSDriver driver) {
        ...
        result.clear();
        By tempElement = null;
        System.out.println(logSpace4thisPage + "xxxxxx ------ Check the driver in IOSPage_FFDryRunDemo . getByMap(IOSDriver driver)   : " + driver.toString());
    ...
    public HashMap<String, By> getByMap(IOSDriver driver, HashMap<StringBuilder, FFPandaElementEntity> eleMap) {
        ...
        result.clear();
        By tempElement = null;
        System.out.println(logSpace4thisPage + "xxxxxx ------ Check the driver in IOSPage_FFDryRunDemo . getByMap (IOSDriver driver, HashMap<String, FFPandaElementEntity> eleMap)  : " + driver.toString());
    ...
    public StringBuilder btnOperationRoute(IOSDriver driver, StringBuilder eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperationRoute in IOSPage_FFDryRunDemo has been called ~~~ +++");
        return super.btnOperation(driver, eleName, this.byMap, this.eleContentMap, this.path4Log);
    }

    public StringBuilder btnOperationRoute_DRYRUN(String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperationRoute_DRYRUN in IOSPage_FFDryRunDemo has been called ~~~ +++");
    ...
    public void btnOperation(IOSDriver driver, StringBuilder eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperation in IOSPage_FFDryRunDemo has been called ~~~ +++");
        super.btnOperation(driver, eleName, this.byMap, this.eleContentMap);
    }

    public void dryrun_text(String eleName, String extPara) throws Exception {
        System.out.println("    +++ ~~~ The dryrun_text in IOSPage_FFDryRunDemo has been called ~~~ +++");
    }
    ...
    public void textOperation(IOSDriver driver, StringBuilder eleName, StringBuilder para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperationn in IOSPage_FFDryRunDemo has been called ~~~ +++");
        super.textOperation(driver, eleName, para1, this.byMap);
    }


    public String dryrun_textfield_input(String eleName, String extPara) throws Exception {
        System.out.println("    +++ ~~~ The dryrun_textfield_input in IOSPage_FFDryRunDemo has been called ~~~ +++");
        return extPara;
    }
    ...
    public StringBuilder textOperationWithSaveInput(IOSDriver driver, StringBuilder eleName, StringBuilder para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperationWithSaveInput in IOSPage_FFDryRunDemo has been called ~~~ +++");
        ...
        if (!eleName.toString().equalsIgnoreCase("PageTitle")) {
            if (movecheckdisable == false) {
                ...
                if (localMoveable == true) {
                    resultText = super.textOperationWithSaveInput(driver, eleName, para1, this.byMap);
                } else {
                    resultText = super.textOperationStaticWithValue(driver, eleName, para1, this.byMap, this.path4Log);
                }
            } else {
                if (moveable == false) {
    ...
    public String dryrun_getElementContent(String eleName) throws Exception {
        return new String("dryrun_getElementContent");
    }

    public StringBuilder getElementContent(IOSDriver driver, StringBuilder eleName) throws Exception {
        System.out.println("    +++ ~~~ The getElementContent in IOSPage_FFDryRunDemo has been called ~~~ +++");
        boolean movecheckdisable = this.content.getFlag4MoveCheck();
        boolean moveable = this.content.getMoveable();
        boolean localMoveable = false;
        ...
        if (!eleName.toString().equalsIgnoreCase("NaviBarBtn")) {
            if (movecheckdisable == false) {
                ...
                if (localMoveable == true) {
                    if (eleType.toString().equalsIgnoreCase("xpath")) {
                        result = super.getElementContent(driver, eleName, eleType, this.byMap, this.eleContentMap);
                    } else if (eleType.toString().equalsIgnoreCase("classname")) {
    ...
    public boolean confirmOperation(IOSDriver driver) throws Exception {
        System.out.println("    +++ ~~~ The confirmOperation in IOSPage_FFDryRunDemo has been called ~~~ +++");
        return super.confirmOperationStatic(driver, new StringBuilder("loginBtn"), this.byMap, this.content.getEleTextMap(), this.path4Log);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            */
            ...
            // IOSPage_Account x = new IOSPage_Account("/PageXML/IOS/bAccount.xml", driver, null);

            IOSPage_FFDryRunDemo x = new IOSPage_FFDryRunDemo(new StringBuilder("/PageXML/IOS/FFDryRunDemo.xml"), null);
