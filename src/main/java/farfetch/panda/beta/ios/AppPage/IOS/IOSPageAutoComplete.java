 ...
 */
public class IOSPageAutoComplete extends IOSPageTemplate {
    protected String fileName = "AutoComplete.json";
    ...
    private static String logSpace4thisPage = " --- IOSPageAutoComplete --";
    ...
    public IOSPageAutoComplete(IOSDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public IOSPageAutoComplete(IOSDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public IOSPageAutoComplete(String theFile, IOSDriver theD, Log theLogger) throws Exception {
    ...
    public HashMap<String, By> getByMap(IOSDriver driver) {
        ...
        result.clear();
        By tempElement = null;
        System.out.println(logSpace4thisPage + "xxxxxx ------ Check the driver in IOSPageAutoComplete . getByMap(IOSDriver driver)   : " + driver.toString());
    ...
    public HashMap<String, By> getByMap(IOSDriver driver, HashMap<String, ElementMapping> eleMap) {
        ...
        result.clear();
        By tempElement = null;
        System.out.println(logSpace4thisPage + "xxxxxx ------ Check the driver in IOSPageAutoComplete . getByMap (IOSDriver driver, HashMap<String, ElementMapping> eleMap)  : " + driver.toString());
    ...
    public String btnOperationRoute(IOSDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperationRoute in IOSPageAutoComplete has been called ~~~ +++");
    ...
    public void btnOperation(IOSDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperation in IOSPageAutoComplete has been called ~~~ +++");
        boolean movecheckdisable = this.content.getFlag4MoveCheck();
        boolean moveable = this.content.getMoveable();
        boolean localMoveable = false;
        if (!eleName.equalsIgnoreCase("PageTitle")) {
    ...
    public String autoCompleteOperation(IOSDriver driver, String eleName, String extPara) throws Exception {  //TODO
        ...
        System.out.println("    +++ ~~~ The autoCompleteOperation in IOSPageAutoComplete has been called ~~~ +++");
        ...
        try {
            ...
            selectItemValue = super.selectItemMAC(driver, extPara, this.byMap, this.eleContentMap, this.path4Log, extPara, new Boolean(true));
            ...
            if (type4check.equals("ready")) {       // ready mode
                ...
                } else if (para4check.equals("title")) // check title for ready mode
                {
                    ...
                    if (temp.size() != 1) {
                        ...
                        String result4ab = super.checkNormalElement(theD, "PageTitle", this.byMap, this.eleContentMap);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            IOSPageAutoComplete x = new IOSPageAutoComplete("/PageXML/AND/loginPage.xml", driver, null);
