 ...
 */
public class FOXPageLogin extends foxPageTemplate {
    protected String fileName = "Login_WEBfox.json";
    ...
    protected HashMap<StringBuilder, AndroidElement> eleMap = null;
    ...
    private static String logSpace4thisPage = " --- FOXPageLogin --";
    ...
    public FOXPageLogin(WebDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public FOXPageLogin(String theFile, WebDriver theD, Log theLogger) throws Exception {
    ...
    public String btnOperationRoute(WebDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperationRoute in FOXPageLogin has been called ~~~ +++");
        try {
    ...
    public void btnOperation(WebDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperation in FOXPageLogin has been called ~~~ +++");
        try {
    ...
    public void textOperation(WebDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperationn in FOXPageLogin has been called ~~~ +++");
        try {
