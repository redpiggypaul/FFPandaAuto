 ...
 */
public class IOSPageDeleteAccount extends IOSPageTemplate {
    protected String fileName = "DeleteAccount.json";
    ...
    public IOSPageDeleteAccount(IOSDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public IOSPageDeleteAccount(IOSDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public IOSPageDeleteAccount(String theFile, IOSDriver theD, Log theLogger) throws Exception {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            IOSPageDeleteAccount x = new IOSPageDeleteAccount("/PageXML/AND/bPageProfileEdit.xml", driver, null);
