package farfetch.panda.beta.ios;
 ...
 */
public abstract class FFPandaIOSPageTemplate {
    ...
    public FFPandaIOSPageTemplate(IOSDriver theD) throws Exception {
    }

    public FFPandaIOSPageTemplate(String theFile, IOSDriver theD, Log theLogger) throws Exception {
    }
    ...
    public HashMap<String, By> getByMap(IOSDriver driver) {
        ...
        for (Iterator it = this.eleContentMap.entrySet().iterator(); it.hasNext(); ) {
            try {
                ...
                System.out.println(logSpace4thisPage + "Check the value in Entry in combind : " + (FFPandaElementEntity) tempContentEntry.getValue() + " !!! ");

                //     tempElement = combindAndElement(driver, (FFPandaElementEntity) tempContentEntry.getValue(), 6, this.osTypeInContent);
    ...
    public boolean loadingJudgement(IOSDriver driver, HashMap<String, FFPandaElementEntity> eleMap) throws Exception {
        boolean result = true;
        try {
            long gstartTime = 0;
            for (; result == true; ) {
    ...
    public boolean loadingCheckNew(IOSDriver driver, HashMap<String, FFPandaElementEntity> extByMap) throws Exception {
    ...
    public boolean checkElementPresent(IOSDriver driver, String eleName, HashMap<String, FFPandaElementEntity> eleMap) throws Exception {
        boolean result = false;
    ...
    public StringBuilder getContentInBtnFast(IOSDriver driver, StringBuilder eleName, HashMap<String, By> extByMap) throws Exception {
    ...
    public WebElement getElementFast(IOSDriver driver, String eleName, HashMap<String, FFPandaElementEntity> eleMap) throws Exception {
        WebElement theResult = null;
        try {
    ...
    public StringBuilder btn4XPATHCombind(IOSDriver driver, String eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap,
    ...
    public By generateByObjWithType(String eleName, HashMap<String, FFPandaElementEntity> eleMap) throws Exception {
        By result = null;
        try {
    ...
    public String getElementXMLContent(String eleName, HashMap<String, FFPandaElementEntity> eleMap) throws Exception {
        StringBuilder result = new StringBuilder();
        try {
            for (Iterator it = eleMap.entrySet().iterator(); it.hasNext(); ) {
                final Map.Entry tempContentEntry = (Map.Entry) it.next();
    ...
    public String getElementXMLDvalue(String eleName, HashMap<String, FFPandaElementEntity> eleMap) throws Exception {
        StringBuilder result = new StringBuilder();
        try {
            for (Iterator it = eleMap.entrySet().iterator(); it.hasNext(); ) {
                final Map.Entry tempContentEntry = (Map.Entry) it.next();
    ...
    public boolean pressDateItem(IOSDriver theD, StringBuilder theDay, HashMap<String, By> thebyMap) throws Exception {  // type4check : ready, loading, error, temp , etc.  , para4check: target element name, all element, title element
...
/*
    ...
    */
    ...
    public void textOperationLogin(IOSDriver driver, StringBuilder eleName, StringBuilder para1, HashMap<String, By> inMap, HashMap<String, String> dValueMap) throws Exception {
        String dValue = null;
    ...
    public void textOperationSendkey(IOSDriver driver, StringBuilder eleName, StringBuilder para1,
                                     HashMap<String, By> inMap, HashMap<String, String> dValueMap) throws Exception {
        String dValue = null;
        IOSElement theResult = null;
        final StringBuilder localPath = this.path4Log;
        try {
    ...
    public void textOperationSmart(IOSDriver driver, StringBuilder eleName, StringBuilder para1,
                                   HashMap<String, By> inMap, HashMap<String, String> dValueMap,
    ...
    public StringBuilder textOperationSmartSaveInput(IOSDriver driver, StringBuilder eleName,
                                                     StringBuilder para1, HashMap<String, By> inMap,
                                                     HashMap<String, String> dValueMap,
    ...
    public StringBuilder textOperationWithSaveInput(IOSDriver driver, StringBuilder eleName,
                                                    StringBuilder para1, HashMap<String, By> inMap) throws Exception {
        StringBuilder result = new StringBuilder();
        WebElement theResult = null;
        final StringBuilder localPath = this.path4Log;
        try {
    ...
    public String checkNormalElement(IOSDriver driver, String
            eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap) throws Exception {
        WebElement theResult = null;
        StringBuilder result = new StringBuilder();
        try {
    ...
    public String autoCompleteOperationSuper(IOSDriver driver, StringBuilder
            eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, StringBuilder p4L,
    ...
    public String autoCompleteStartMAC(IOSDriver driver, String eleName, HashMap<String, By> inMap,
                                       HashMap<String, FFPandaElementEntity> eleMap, final StringBuilder p4L, StringBuilder dValue,
    ...
    public StringBuilder selectCompareItemMAC(IOSDriver driver, StringBuilder eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, final StringBuilder p4L, StringBuilder extPara, Boolean contentIsolatedClickable) throws Exception {  //TODO
        StringBuilder result = new StringBuilder();
    ...
    public StringBuilder textOperationListWithSaveInput(IOSDriver driver, StringBuilder eleName, StringBuilder para1, HashMap<String, By> inMap, StringBuilder dValuePara) throws Exception {
        StringBuilder result = new StringBuilder();
    ...
    public StringBuilder getElementContent(IOSDriver driver, StringBuilder
            eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap) throws
            Exception {
        WebElement theResult = null;
        StringBuilder result = new StringBuilder();
        final StringBuilder localPath = this.path4Log;
    ...
    public boolean checkMoveable(IOSDriver driver, String eleName, HashMap<String, By> byMap, HashMap<String, FFPandaElementEntity> eleContentMap, String path4log) throws Exception {
    ...
    public StringBuilder getElementContent(IOSDriver driver, StringBuilder
            locatorStr, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, StringBuilder p4L,
    ...
    public List<String> getElementContentListMove(IOSDriver driver, String
            eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, StringBuilder p4L) throws
            Exception {
    ...
    public void textListOperationexact(IOSDriver driver, By extTempBy, StringBuilder
            para1, HashMap<String, By> inMap, HashMap<String, String> dValueMap, StringBuilder eleName) throws Exception {
        String dValue = null;
        IOSElement theResult = null;
        List<WebElement> resultlist = null;
        final StringBuilder localPath = this.path4Log;
    ...
    public StringBuilder textListOperationWithSaveInput(IOSDriver driver, StringBuilder eleName, StringBuilder
            para1, HashMap<String, By> inMap, HashMap<String, String> dValueMap, StringBuilder path4Log) throws Exception {
    ...
    public StringBuilder textListOperationWithSaveInputMAC(IOSDriver driver, StringBuilder eleName, StringBuilder
            para1, HashMap<String, By> inMap, HashMap<String, String> dValueMap, StringBuilder p4l) throws Exception {
        StringBuilder result = new StringBuilder();
        StringBuilder dValue = null;
        List<WebElement> resultlist = null;
        IOSElement theResult = null;
    ...
    public WebElement findFilteEleWithSearch(IOSDriver driver, String eleName, int timeValue, StringBuilder path, StringBuilder tText, HashMap<String, FFPandaElementEntity> eleMap, StringBuilder btnStr) throws Exception {
        List<WebElement> resultlist = null;
        WebElement theEle = null;
    ...
    public WebElement findFilteEleWithLocationCompare(IOSDriver driver, StringBuilder eleName, int timeValue, StringBuilder path, StringBuilder tText, HashMap<String, FFPandaElementEntity> eleMap, int extTitleY, int extNextTitleY, int ind4ClassName) throws Exception {
        List<WebElement> resultlist = null;
        WebElement theEle = null;
        WebElement theBtnEle = null;
    ...
    public void btnOperation(IOSDriver driver, StringBuilder eleName, HashMap<String, By> inMap) throws Exception {
        final StringBuilder localPath = this.path4Log;
        WebElement theResult = null;
        try {
            System.out.println("    +++ ~~~ In the FFPandaIOSPageTemplate ~~~ +++");
    ...
    public StringBuilder checkLocaterStr(StringBuilder btnName, HashMap<String, FFPandaElementEntity> eleMap) {
        StringBuilder result = new StringBuilder();
        for (Iterator it = eleMap.entrySet().iterator(); it.hasNext(); ) {
            Map.Entry tempContentEntry = (Map.Entry) it.next();
    ...
    public StringBuilder checkTheLocaterType(StringBuilder btnName, HashMap<String, FFPandaElementEntity> eleMap) {
    ...
    public StringBuilder checkThe(String btnName, HashMap<String, FFPandaElementEntity> eleMap) {
        StringBuilder result = null;
        for (Iterator it = eleMap.entrySet().iterator(); it.hasNext(); ) {
            Map.Entry tempContentEntry = (Map.Entry) it.next();
            StringBuilder tempType = ((FFPandaElementEntity) tempContentEntry.getValue()).getLocatorType();
    ...
    private StringBuilder checkTheTextContent(StringBuilder btnName, HashMap<String, FFPandaElementEntity> eleMap) throws InterruptedException {
    ...
    public StringBuilder btnOperation(IOSDriver driver, StringBuilder eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap) throws Exception {
        StringBuilder result = new StringBuilder();
        WebElement theResult = null;
        final StringBuilder localPath = this.path4Log;
        try {
    ...
    public StringBuilder btnOperation(IOSDriver driver, StringBuilder eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, HashMap<String, String> textMap) throws Exception {
        StringBuilder result = new StringBuilder();
        WebElement theResult = null;
        final StringBuilder localPath = this.path4Log;
        try {
    ...
    public StringBuilder btnOperationSmart(IOSDriver driver, StringBuilder eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, HashMap<String, String> textMap,
    ...
    public StringBuilder btnOperationSmartHome(IOSDriver driver, StringBuilder eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap,
                                               HashMap<String, String> textMap, final StringBuilder tText, StringBuilder extPath) throws Exception {
        StringBuilder result = new StringBuilder();
        WebElement theResult = null;
        final StringBuilder localPath = extPath;
        try {
    ...
    public StringBuilder btnOperationIsolateSmart(IOSDriver driver, StringBuilder eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap,
                                                  HashMap<String, String> textMap, final StringBuilder tText, StringBuilder extPath) throws Exception {
        StringBuilder result = new StringBuilder();
        IOSElement theResult = null;
    ...
    public int btnId4ClassNameIsolate(IOSDriver driver, StringBuilder eleName, StringBuilder eleType, StringBuilder eleStr, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap,
                                      HashMap<String, String> textMap, final StringBuilder tText) throws Exception {
        int resIndex = 0;
        WebElement theResult = null;
        final StringBuilder localPath = this.path4Log;
        try {
    ...
    public StringBuilder btn4ClassNameCombind(IOSDriver driver, StringBuilder eleName, StringBuilder eleType, StringBuilder eleStr, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap,
                                              HashMap<String, String> textMap, final StringBuilder tText) throws Exception {
        StringBuilder result = new StringBuilder();
        int resIndex = 0;
        WebElement theResult = null;
    ...
    public int btnId4ClassNameIsolate(IOSDriver driver, String eleName, StringBuilder eleType, StringBuilder eleStr, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap,
                                      HashMap<String, String> textMap, final StringBuilder tText, PageIndexGroup indexGroupFromPage) throws Exception {
        int resIndex = 0;
        WebElement theResult = null;
        final StringBuilder localPath = this.path4Log;
        try {
    ...
    public StringBuilder btnOperationStatic(IOSDriver driver, StringBuilder eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, HashMap<String, String> textMap, StringBuilder extPath) throws Exception {
        StringBuilder result = new StringBuilder();
        WebElement theResult = null;
        final StringBuilder localPath = extPath;
        try {
    ...
    public boolean confirmOperationStatic(IOSDriver driver, StringBuilder eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, HashMap<String, String> textMap, StringBuilder extPath) throws Exception {
        boolean result = false;
        WebElement theResult = null;
        final StringBuilder localPath = extPath;
        try {
    ...
    public boolean titleCheck(IOSDriver driver, StringBuilder eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, HashMap<String, String> textMap, StringBuilder extPath) throws Exception {
        boolean result = false;
        WebElement theResult = null;
        final StringBuilder localPath = extPath;
        try {
    ...
    public StringBuilder getElementContentStatic(IOSDriver driver, StringBuilder locatorStr, StringBuilder locatorType, HashMap<String, By> inMap,
                                                 HashMap<String, FFPandaElementEntity> eleMap, StringBuilder p4L, int TITLEindex) throws Exception {
        StringBuilder result = new StringBuilder();
        WebElement theResult = null;
    ...
    public StringBuilder textOperationStatic(IOSDriver driver, StringBuilder eleName, StringBuilder para, HashMap<String, By> inMap, HashMap<String, String> textMap, StringBuilder extPath) throws Exception {
        StringBuilder result = new StringBuilder();
        IOSElement theResult = null;
        final StringBuilder localPath = extPath;
        try {
    ...
    public StringBuilder textOperationStaticLogin(IOSDriver driver, StringBuilder eleName, StringBuilder para, HashMap<String, By> inMap, HashMap<String, String> textMap, StringBuilder extPath) throws Exception {
        StringBuilder result = new StringBuilder();
        IOSElement theResult = null;
        final StringBuilder localPath = extPath;
        try {
    ...
    public StringBuilder textOperationStaticSendkey(IOSDriver driver, StringBuilder eleName, StringBuilder para, HashMap<String, By> inMap, HashMap<String, String> textMap, StringBuilder extPath) throws Exception {
        StringBuilder result = new StringBuilder();
        IOSElement theResult = null;
        final StringBuilder localPath = extPath;
        try {
    ...
    public StringBuilder textOperationStaticWithValue(IOSDriver driver, StringBuilder eleName, StringBuilder para, HashMap<String, By> inMap, HashMap<String, String> textMap, StringBuilder extPath) throws Exception {
        StringBuilder result = new StringBuilder();
        IOSElement theResult = null;
        final StringBuilder localPath = extPath;
        try {
    ...
    public StringBuilder textOperationStaticWithValueSendKey(IOSDriver driver, StringBuilder eleName, StringBuilder para, HashMap<String, By> inMap, HashMap<String, String> textMap, StringBuilder extPath) throws Exception {
        StringBuilder result = new StringBuilder();
        IOSElement theResult = null;
        final StringBuilder localPath = extPath;
        try {
    ...
    public StringBuilder btnOperationDync(IOSDriver driver, StringBuilder eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, HashMap<String, String> textMap,
    ...
    public StringBuilder calendarOperation(IOSDriver driver, StringBuilder eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, StringBuilder p4L) throws Exception {  // click only
        StringBuilder result = new StringBuilder();
        Thread.sleep(1000);
        final StringBuilder localPath = p4L;
        WebElement theResult = null;
    ...
    public StringBuilder absCalendarOpenWin(IOSDriver driver, StringBuilder
            eleName, final HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, StringBuilder p4L) throws Exception {
        StringBuilder result = new StringBuilder();
        Thread.sleep(1000);
        final StringBuilder localPath = p4L;
        WebElement theResult = null;
    ...
    public StringBuilder calendarOperationSuper(IOSDriver driver, StringBuilder
            eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, StringBuilder p4L, StringBuilder tDate, StringBuilder dateWinName) throws Exception {  // click only
        StringBuilder result = new StringBuilder();
        StringBuilder calendarValue = null;
    ...
    public StringBuilder calendarOperationYandM(IOSDriver driver, StringBuilder
            eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, StringBuilder p4L, StringBuilder tMonth, StringBuilder dateWinName) throws Exception {  // click only
        StringBuilder result = new StringBuilder();
        StringBuilder calendarValue = null;
    ...
    public StringBuilder calendarOperationSuper(IOSDriver driver, StringBuilder
            eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, StringBuilder p4L, StringBuilder dateWinName) throws Exception {  // click only
        StringBuilder result = new StringBuilder();
        StringBuilder calendarValue = null;
        StringBuilder dateWin = dateWinName;
        int daylastmonth = dateHandle.getLastDayOfLastMonth(new Date(), "America/Chicago");
    ...
    public StringBuilder getSingleEleTextGroup(IOSDriver driver, StringBuilder eleName, HashMap<String, By> inMap) throws
            Exception {
    ...
    public StringBuilder calendarGetTextOperation(IOSDriver driver, StringBuilder eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, StringBuilder p4L) throws Exception {
        StringBuilder result = new StringBuilder();
        WebElement theResult = null;
        Thread.sleep(1000);
        final StringBuilder localPath = p4L;
...
// TODO make following loop quit with suitable reason
    ...
    public StringBuilder dropDownListShow(IOSDriver driver, StringBuilder eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap,
                                          final StringBuilder p4L, HashMap<String, String> dValueMap) throws Exception {
        StringBuilder result = new StringBuilder();
        Thread.sleep(1000);
        final StringBuilder localPath = p4L;
        WebElement theResult = null;
    ...
    public StringBuilder dropDownItemChoose(IOSDriver driver, StringBuilder preiousText, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, final StringBuilder p4L) throws Exception {  //TODO
        StringBuilder result = new StringBuilder();
    ...
    public StringBuilder dropDownItemChooseRoll(IOSDriver driver, StringBuilder preiousText, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, final StringBuilder p4L, StringBuilder eleName) throws Exception {  //TODO
        StringBuilder result = new StringBuilder();
        WebElement theResult = null;
        Thread.sleep(1000);
    ...
    public StringBuilder dropDownItemChooseWithPara(IOSDriver driver, StringBuilder preiousText, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, final StringBuilder p4L, StringBuilder extPara) throws Exception {  //TODO
        StringBuilder result = new StringBuilder();
        List<WebElement> theResult = new ArrayList<WebElement>();
        WebElement choosedItem = null;
        Thread.sleep(1000);
    ...
    public StringBuilder dropDownItemChooseRollWithPara(IOSDriver driver, StringBuilder preiousText, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap,
    ...
    public StringBuilder singleItemChoose(IOSDriver driver, StringBuilder preiousText, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, final StringBuilder p4L) throws Exception {  //TODO
        StringBuilder result = new StringBuilder();
        List<WebElement> theResult = new ArrayList<WebElement>();
        WebElement choosedItem = null;
        Thread.sleep(1000);
    ...
    public StringBuilder singleItemChooseWithPara(IOSDriver driver, StringBuilder preiousText, HashMap<String, By> inMap,
                                                  HashMap<String, FFPandaElementEntity> eleMap, final StringBuilder p4L, StringBuilder extPara) throws Exception {  //TODO
        StringBuilder result = new StringBuilder();
        List<WebElement> theResult = new ArrayList<WebElement>();
        WebElement choosedItem = null;
        Thread.sleep(1000);
    ...
    public StringBuilder multiItemChoose(IOSDriver driver, StringBuilder preiousText, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, final StringBuilder p4L) throws Exception {  //TODO
        StringBuilder result = new StringBuilder();
        List<WebElement> theResult = new ArrayList<WebElement>();
        WebElement choosedItem = null;
        Thread.sleep(1000);
    ...
    public StringBuilder multiItemChooseWithPara(IOSDriver driver, StringBuilder preiousText, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, final StringBuilder p4L, StringBuilder extPara) throws Exception {  //TODO
        StringBuilder result = new StringBuilder();
        List<WebElement> theResult = new ArrayList<WebElement>();
        WebElement choosedItem = null;
    ...
    public StringBuilder searchStart(IOSDriver driver, StringBuilder eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, final StringBuilder p4L, StringBuilder dValue, StringBuilder extPara) throws Exception {
        StringBuilder result = new StringBuilder();
        WebElement theResult = null;
        Thread.sleep(1000);
        final StringBuilder localPath = p4L;
    ...
    public StringBuilder searchStartMAC(IOSDriver driver, StringBuilder eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, final StringBuilder p4L, StringBuilder dValue, StringBuilder extPara) throws Exception {
        StringBuilder result = new StringBuilder();
        IOSElement theResult = null;
        Thread.sleep(1000);
        final StringBuilder localPath = p4L;
    ...
    public StringBuilder selectItem(IOSDriver driver, StringBuilder eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap,
    ...
    public StringBuilder btnOperationHome(IOSDriver driver, StringBuilder eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, HashMap<String, String> textMap, StringBuilder extPath) throws Exception {
        StringBuilder result = new StringBuilder();
        WebElement theResult = null;
        final StringBuilder localPath = extPath;
        try {
    ...
    public StringBuilder selectItemMAC(IOSDriver driver, StringBuilder eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, final StringBuilder p4L, StringBuilder extPara, Boolean contentIsolatedClickable) throws Exception {  //TODO
        StringBuilder result = new StringBuilder();
        List<WebElement> theResultList = new ArrayList<WebElement>();
        WebElement choosedItem = null;
        Thread.sleep(2500);
    ...
    public StringBuilder checkCalendarDate(IOSDriver driver, StringBuilder eleName, HashMap<String, By> inMap, StringBuilder p4L) throws Exception {
        StringBuilder result = new StringBuilder();
        WebElement theResult = null;
        Thread.sleep(1000);
        final StringBuilder localPath = p4L;
    ...
    public StringBuilder btnOperation(IOSDriver driver, StringBuilder eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, StringBuilder p4L) throws Exception {
        StringBuilder result = new StringBuilder();
        IOSElement theResult = null;
        Thread.sleep(1000);
        final StringBuilder localPath = p4L;
    ...
    public StringBuilder btnOperation(IOSDriver driver, StringBuilder eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, StringBuilder p4L, HashMap<String, String> textMap) throws Exception {
        StringBuilder result = new StringBuilder();
        IOSElement theResult = null;
        final StringBuilder localPath = p4L;
        try {
    ...
    public StringBuilder btnOperationDync(IOSDriver driver, StringBuilder eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, StringBuilder p4L, HashMap<String, String> textMap, Boolean movedheckdisable, Boolean moveable) throws Exception {
        StringBuilder result = new StringBuilder();
        IOSElement theResult = null;
    ...
    public StringBuilder btnOperationListMatch(IOSDriver driver, StringBuilder eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, StringBuilder p4L) throws Exception {
        StringBuilder result = new StringBuilder();
        List<WebElement> theResult = null;
        Thread.sleep(1000);
        final StringBuilder localPath = p4L;
    ...
    public StringBuilder btnOperationAutoIndex(IOSDriver driver, StringBuilder eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, StringBuilder p4L) throws Exception {   //TODO
        StringBuilder result = new StringBuilder();
        Thread.sleep(1000);
        final StringBuilder localPath = p4L;
        int index4item = 1;
    ...
    public StringBuilder getElementContentSmart(IOSDriver driver, StringBuilder locatorStr, StringBuilder locatorType, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, StringBuilder p4L, int TITLEindex) throws Exception {
        StringBuilder result = new StringBuilder();
        List<WebElement> eleList = new ArrayList<WebElement>();
    ...
    public StringBuilder getStaticElementContent(IOSDriver driver, StringBuilder locatorStr, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, StringBuilder p4L, int TITLEindex) throws Exception {
        StringBuilder result = new StringBuilder();
        String localStr = null;
        Thread.sleep(1000);
        int steprange = 3;
    ...
    public StringBuilder autoSearch(IOSDriver driver, StringBuilder eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, StringBuilder p4L) throws Exception {
        StringBuilder result = new StringBuilder();
        WebElement theResult = null;
        Thread.sleep(1000);
        final StringBuilder localPath = p4L;
    ...
    public StringBuilder textOperationSmartClickSaveInput(IOSDriver driver, StringBuilder eleName,
                                                          StringBuilder para1, HashMap<String, By> inMap, HashMap<String, String> dValueMap, final StringBuilder path) throws Exception {
        StringBuilder result = new StringBuilder();
        IOSElement theResult = null;
        final StringBuilder localPath = path;
        try {
    ...
    private IOSElement filterBtnElement(IOSDriver driver, IOSDriverWait xWait, By theByKey, StringBuilder eleName, HashMap<String, FFPandaElementEntity> eleMap, int extindex4path) throws Exception {
    ...
    private IOSElement filterBtnElementOLD(IOSDriver driver, IOSDriverWait xWait, By theByKey, StringBuilder eleName, HashMap<String, FFPandaElementEntity> eleMap) throws Exception {
        boolean review = false;
        int moveAccount = 10;
        IOSElement result = null;
        List<IOSElement> temp = new ArrayList<IOSElement>();
    ...
    private int getIndex4BtnElement(IOSDriver driver, IOSDriverWait xWait, By theByKey, StringBuilder eleName, HashMap<String, FFPandaElementEntity> eleMap) throws Exception {
        boolean review = false;
        int moveAccount = 10;
        IOSElement result = null;
        List<IOSElement> temp = new ArrayList<IOSElement>();
    ...
    private IOSElement filterRecordElement(IOSDriver driver, IOSDriverWait xWait, By theByKey, StringBuilder eleName, HashMap<String, FFPandaElementEntity> eleMap) throws Exception {
        boolean review = false;
        int moveAccount = 10;
        IOSElement result = null;
        List<IOSElement> temp = new ArrayList<IOSElement>();
    ...
    public StringBuilder btnOperationSearch(IOSDriver driver, StringBuilder eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, StringBuilder p4L, int index4xpath) throws Exception {
        StringBuilder result = new StringBuilder();
        IOSElement theResult = null;
        Thread.sleep(500);
        final StringBuilder localPath = p4L;
    ...
    public StringBuilder isolatedBtnSearchWithIndex(IOSDriver driver, final StringBuilder eleName, final StringBuilder comType, final StringBuilder comStr, final HashMap<String, By> inMap, final HashMap<String, FFPandaElementEntity> eleMap, StringBuilder p4L, int ind4xpath, HashMap<String, String> textMap, final StringBuilder tText, final int index4ClassName, final StringBuilder btnType, final StringBuilder btnStr) throws Exception {
        StringBuilder result = new StringBuilder();
        IOSElement theResult = null;
    ...
    public StringBuilder isolatedBtnSearchWithIndex(IOSDriver driver, final StringBuilder eleName, final StringBuilder comType, final StringBuilder comStr, final HashMap<String, By> inMap,
                                                    final HashMap<String, FFPandaElementEntity> eleMap, StringBuilder p4L, int ind4xpath, HashMap<String, String> textMap,
    ...
    public StringBuilder isolatedRecordSearchWithLocation(IOSDriver driver, final StringBuilder eleName, final StringBuilder recordType, final StringBuilder recordStr, final HashMap<String, By> inMap, final HashMap<String, FFPandaElementEntity> eleMap, StringBuilder p4L, int ind4xpath, HashMap<String, String> textMap, final StringBuilder tText, final int index4ClassName, final StringBuilder comType, final StringBuilder comStr) throws Exception {
        StringBuilder result = new StringBuilder();
        IOSElement theResult = null;
    ...
    public int getIndex4TitleIndex(IOSDriver driver, StringBuilder eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, StringBuilder p4L, int index4xpath) throws Exception, InterruptedException {
        StringBuilder result = new StringBuilder();
        Thread.sleep(500);
        final StringBuilder localPath = p4L;
        try {
    ...
    public StringBuilder recordSearch(IOSDriver driver, StringBuilder eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, StringBuilder p4L, int index4path, StringBuilder type, StringBuilder rowLocatorString, StringBuilder recordType, StringBuilder recordLocatorStr, HashMap<String, Integer> waitStepMap) throws Exception {
        StringBuilder result = new StringBuilder();
        IOSElement theResult = null;
        Thread.sleep(500);
        final StringBuilder localPath = p4L;
    ...
    public StringBuilder btnMatchSearchByValue(IOSDriver driver, StringBuilder eleName, HashMap<String, By> inMap,
                                               HashMap<String, FFPandaElementEntity> eleMap, StringBuilder p4L,
    ...
    public StringBuilder contentMatchSearchByValue(IOSDriver driver, StringBuilder eleName, HashMap<String, By> inMap,
                                                   HashMap<String, FFPandaElementEntity> eleMap, StringBuilder p4L,
                                                   int index4path, StringBuilder type, StringBuilder rowLocatorString,
                                                   StringBuilder recordType, StringBuilder recordLocatorStr,
                                                   HashMap<String, Integer> waitStepMap, StringBuilder key) throws Exception {
    ...
    public StringBuilder rollTheRound(IOSDriver driver, StringBuilder
            eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap,
    ...
    //TODO
    public StringBuilder getElementContent(IOSDriver driver, StringBuilder
            eleName, StringBuilder eleType, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap,
                                           HashMap<String, String> textMap) throws
            Exception {
        WebElement theResult = null;
        List<WebElement> eleList = new ArrayList<WebElement>();
        StringBuilder result = new StringBuilder();
    ...
    public StringBuilder getElementContent(IOSDriver driver, StringBuilder
            eleName, HashMap<String, By> inMap, HashMap<String, FFPandaElementEntity> eleMap, boolean flag4search) throws
    ...
    public boolean getSingleEle(IOSDriver driver, StringBuilder eleName, HashMap<String, By> inMap) throws
            Exception {
        WebElement theResult = null;
        boolean result = false;
        try {
    ...
    public StringBuilder getSingleEleText(IOSDriver driver, StringBuilder eleName, HashMap<String, By> inMap) throws
            Exception {
        WebElement theResult = null;
        StringBuilder result = new StringBuilder();
        try {
    ...
    public StringBuilder comPageCheckWithInstanceInfo(IOSDriver theD, StringBuilder type4check, StringBuilder para4check, FFPandaIOSPageContent inContent, HashMap<StringBuilder, FFPandaElementEntity> inEleContentMap, HashMap<String, By> inByMap) {  // type4check : ready, loading, error, temp , etc.  , para4check: target element name, all element, title element
        StringBuilder result = new StringBuilder();
        boolean flag = false;
        StringBuilder eleText = null;
        try {
    ...
    public String comPageCheck(IOSDriver theD, String type4check, String para4check, FFPandaIOSPageContent
            tContent, HashMap<StringBuilder, FFPandaElementEntity> eMap, HashMap<String, By> bMap) {  // type4check : ready, loading, error, temp , etc.  , para4check: target element name, all element, title element
        StringBuilder result = new StringBuilder();
        boolean flag = false;
        try {
            if (type4check.equals("ready")) {       // ready mode
    ...
    public StringBuilder recordSearch(IOSDriver driver, StringBuilder
            eleName, HashMap<String, FFPandaElementEntity> eleMap, StringBuilder p4L, int index4path, StringBuilder type, StringBuilder
    ...
    public boolean pressMonthItem(IOSDriver theD, StringBuilder theMonth, HashMap<String, By> thebyMap) throws Exception {  // type4check : ready, loading, error, temp , etc.  , para4check: target element name, all element, title element
    ...
    public StringBuilder checkTheNextPage(StringBuilder btnName, HashMap<String, FFPandaElementEntity> eleMap) {
        StringBuilder result = null;
        for (Iterator it = eleMap.entrySet().iterator(); it.hasNext(); ) {
            Map.Entry tempContentEntry = (Map.Entry) it.next();
